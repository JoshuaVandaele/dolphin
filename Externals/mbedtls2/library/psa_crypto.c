...
typedef struct {
  ...
  mbedtls2_psa_random_context_t rng;
} psa_global_data_t;

static psa_global_data_t global_data;

#if !defined(MBEDTLS2_PSA_CRYPTO_EXTERNAL_RNG)
mbedtls2_psa_drbg_context_t *const mbedtls2_psa_random_state =
...
psa_status_t mbedtls2_to_psa_error(int ret) {
  ...
  case MBEDTLS2_ERR_AES_INVALID_KEY_LENGTH:
  case MBEDTLS2_ERR_AES_INVALID_INPUT_LENGTH:
  case MBEDTLS2_ERR_AES_FEATURE_UNAVAILABLE:
    return (PSA_ERROR_NOT_SUPPORTED);
  case MBEDTLS2_ERR_AES_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_ARC4_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_ASN1_OUT_OF_DATA:
  case MBEDTLS2_ERR_ASN1_UNEXPECTED_TAG:
  case MBEDTLS2_ERR_ASN1_INVALID_LENGTH:
  case MBEDTLS2_ERR_ASN1_LENGTH_MISMATCH:
  case MBEDTLS2_ERR_ASN1_INVALID_DATA:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_ASN1_ALLOC_FAILED:
    return (PSA_ERROR_INSUFFICIENT_MEMORY);
  case MBEDTLS2_ERR_ASN1_BUF_TOO_SMALL:
    return (PSA_ERROR_BUFFER_TOO_SMALL);

#if defined(MBEDTLS2_ERR_BLOWFISH_BAD_INPUT_DATA)
  case MBEDTLS2_ERR_BLOWFISH_BAD_INPUT_DATA:
#elif defined(MBEDTLS2_ERR_BLOWFISH_INVALID_KEY_LENGTH)
  case MBEDTLS2_ERR_BLOWFISH_INVALID_KEY_LENGTH:
#endif
  case MBEDTLS2_ERR_BLOWFISH_INVALID_INPUT_LENGTH:
    return (PSA_ERROR_NOT_SUPPORTED);
  case MBEDTLS2_ERR_BLOWFISH_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

#if defined(MBEDTLS2_ERR_CAMELLIA_BAD_INPUT_DATA)
  case MBEDTLS2_ERR_CAMELLIA_BAD_INPUT_DATA:
#elif defined(MBEDTLS2_ERR_CAMELLIA_INVALID_KEY_LENGTH)
  case MBEDTLS2_ERR_CAMELLIA_INVALID_KEY_LENGTH:
#endif
  case MBEDTLS2_ERR_CAMELLIA_INVALID_INPUT_LENGTH:
    return (PSA_ERROR_NOT_SUPPORTED);
  case MBEDTLS2_ERR_CAMELLIA_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_CCM_BAD_INPUT:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_CCM_AUTH_FAILED:
    return (PSA_ERROR_INVALID_SIGNATURE);
  case MBEDTLS2_ERR_CCM_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_CHACHA20_BAD_INPUT_DATA:
    return (PSA_ERROR_INVALID_ARGUMENT);

  case MBEDTLS2_ERR_CHACHAPOLY_BAD_STATE:
    return (PSA_ERROR_BAD_STATE);
  case MBEDTLS2_ERR_CHACHAPOLY_AUTH_FAILED:
    return (PSA_ERROR_INVALID_SIGNATURE);

  case MBEDTLS2_ERR_CIPHER_FEATURE_UNAVAILABLE:
    return (PSA_ERROR_NOT_SUPPORTED);
  case MBEDTLS2_ERR_CIPHER_BAD_INPUT_DATA:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_CIPHER_ALLOC_FAILED:
    return (PSA_ERROR_INSUFFICIENT_MEMORY);
  case MBEDTLS2_ERR_CIPHER_INVALID_PADDING:
    return (PSA_ERROR_INVALID_PADDING);
  case MBEDTLS2_ERR_CIPHER_FULL_BLOCK_EXPECTED:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_CIPHER_AUTH_FAILED:
    return (PSA_ERROR_INVALID_SIGNATURE);
  case MBEDTLS2_ERR_CIPHER_INVALID_CONTEXT:
    return (PSA_ERROR_CORRUPTION_DETECTED);
  case MBEDTLS2_ERR_CIPHER_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_CMAC_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

#if !(defined(MBEDTLS2_PSA_CRYPTO_EXTERNAL_RNG) ||                      \
      defined(MBEDTLS2_PSA_HMAC_DRBG_MD_TYPE))
  /* Only check CTR_DRBG error codes if underlying mbedtls2_xxx
   * functions are passed a CTR_DRBG instance. */
  case MBEDTLS2_ERR_CTR_DRBG_ENTROPY_SOURCE_FAILED:
    return (PSA_ERROR_INSUFFICIENT_ENTROPY);
  case MBEDTLS2_ERR_CTR_DRBG_REQUEST_TOO_BIG:
  case MBEDTLS2_ERR_CTR_DRBG_INPUT_TOO_BIG:
    return (PSA_ERROR_NOT_SUPPORTED);
  case MBEDTLS2_ERR_CTR_DRBG_FILE_IO_ERROR:
    return (PSA_ERROR_INSUFFICIENT_ENTROPY);
#endif

  case MBEDTLS2_ERR_DES_INVALID_INPUT_LENGTH:
    return (PSA_ERROR_NOT_SUPPORTED);
  case MBEDTLS2_ERR_DES_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_ENTROPY_NO_SOURCES_DEFINED:
  case MBEDTLS2_ERR_ENTROPY_NO_STRONG_SOURCE:
  case MBEDTLS2_ERR_ENTROPY_SOURCE_FAILED:
    return (PSA_ERROR_INSUFFICIENT_ENTROPY);

  case MBEDTLS2_ERR_GCM_AUTH_FAILED:
    return (PSA_ERROR_INVALID_SIGNATURE);
  case MBEDTLS2_ERR_GCM_BAD_INPUT:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_GCM_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

#if !defined(MBEDTLS2_PSA_CRYPTO_EXTERNAL_RNG) &&                       \
    defined(MBEDTLS2_PSA_HMAC_DRBG_MD_TYPE)
  /* Only check HMAC_DRBG error codes if underlying mbedtls2_xxx
   * functions are passed a HMAC_DRBG instance. */
  case MBEDTLS2_ERR_HMAC_DRBG_ENTROPY_SOURCE_FAILED:
    return (PSA_ERROR_INSUFFICIENT_ENTROPY);
  case MBEDTLS2_ERR_HMAC_DRBG_REQUEST_TOO_BIG:
  case MBEDTLS2_ERR_HMAC_DRBG_INPUT_TOO_BIG:
    return (PSA_ERROR_NOT_SUPPORTED);
  case MBEDTLS2_ERR_HMAC_DRBG_FILE_IO_ERROR:
    return (PSA_ERROR_INSUFFICIENT_ENTROPY);
#endif

  case MBEDTLS2_ERR_MD2_HW_ACCEL_FAILED:
  case MBEDTLS2_ERR_MD4_HW_ACCEL_FAILED:
  case MBEDTLS2_ERR_MD5_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_MD_FEATURE_UNAVAILABLE:
    return (PSA_ERROR_NOT_SUPPORTED);
  case MBEDTLS2_ERR_MD_BAD_INPUT_DATA:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_MD_ALLOC_FAILED:
    return (PSA_ERROR_INSUFFICIENT_MEMORY);
  case MBEDTLS2_ERR_MD_FILE_IO_ERROR:
    return (PSA_ERROR_STORAGE_FAILURE);
  case MBEDTLS2_ERR_MD_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_MPI_FILE_IO_ERROR:
    return (PSA_ERROR_STORAGE_FAILURE);
  case MBEDTLS2_ERR_MPI_BAD_INPUT_DATA:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_MPI_INVALID_CHARACTER:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_MPI_BUFFER_TOO_SMALL:
    return (PSA_ERROR_BUFFER_TOO_SMALL);
  case MBEDTLS2_ERR_MPI_NEGATIVE_VALUE:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_MPI_DIVISION_BY_ZERO:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_MPI_NOT_ACCEPTABLE:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_MPI_ALLOC_FAILED:
    return (PSA_ERROR_INSUFFICIENT_MEMORY);

  case MBEDTLS2_ERR_PK_ALLOC_FAILED:
    return (PSA_ERROR_INSUFFICIENT_MEMORY);
  case MBEDTLS2_ERR_PK_TYPE_MISMATCH:
  case MBEDTLS2_ERR_PK_BAD_INPUT_DATA:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_PK_FILE_IO_ERROR:
    return (PSA_ERROR_STORAGE_FAILURE);
  case MBEDTLS2_ERR_PK_KEY_INVALID_VERSION:
  case MBEDTLS2_ERR_PK_KEY_INVALID_FORMAT:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_PK_UNKNOWN_PK_ALG:
    return (PSA_ERROR_NOT_SUPPORTED);
  case MBEDTLS2_ERR_PK_PASSWORD_REQUIRED:
  case MBEDTLS2_ERR_PK_PASSWORD_MISMATCH:
    return (PSA_ERROR_NOT_PERMITTED);
  case MBEDTLS2_ERR_PK_INVALID_PUBKEY:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_PK_INVALID_ALG:
  case MBEDTLS2_ERR_PK_UNKNOWN_NAMED_CURVE:
  case MBEDTLS2_ERR_PK_FEATURE_UNAVAILABLE:
    return (PSA_ERROR_NOT_SUPPORTED);
  case MBEDTLS2_ERR_PK_SIG_LEN_MISMATCH:
    return (PSA_ERROR_INVALID_SIGNATURE);
  case MBEDTLS2_ERR_PK_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_PLATFORM_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);
  case MBEDTLS2_ERR_PLATFORM_FEATURE_UNSUPPORTED:
    return (PSA_ERROR_NOT_SUPPORTED);

  case MBEDTLS2_ERR_RIPEMD160_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_RSA_BAD_INPUT_DATA:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_RSA_INVALID_PADDING:
    return (PSA_ERROR_INVALID_PADDING);
  case MBEDTLS2_ERR_RSA_KEY_GEN_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);
  case MBEDTLS2_ERR_RSA_KEY_CHECK_FAILED:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_RSA_PUBLIC_FAILED:
  case MBEDTLS2_ERR_RSA_PRIVATE_FAILED:
    return (PSA_ERROR_CORRUPTION_DETECTED);
  case MBEDTLS2_ERR_RSA_VERIFY_FAILED:
    return (PSA_ERROR_INVALID_SIGNATURE);
  case MBEDTLS2_ERR_RSA_OUTPUT_TOO_LARGE:
    return (PSA_ERROR_BUFFER_TOO_SMALL);
  case MBEDTLS2_ERR_RSA_RNG_FAILED:
    return (PSA_ERROR_INSUFFICIENT_ENTROPY);
  case MBEDTLS2_ERR_RSA_UNSUPPORTED_OPERATION:
    return (PSA_ERROR_NOT_SUPPORTED);
  case MBEDTLS2_ERR_RSA_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_SHA1_HW_ACCEL_FAILED:
  case MBEDTLS2_ERR_SHA256_HW_ACCEL_FAILED:
  case MBEDTLS2_ERR_SHA512_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_XTEA_INVALID_INPUT_LENGTH:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_XTEA_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_ECP_BAD_INPUT_DATA:
  case MBEDTLS2_ERR_ECP_INVALID_KEY:
    return (PSA_ERROR_INVALID_ARGUMENT);
  case MBEDTLS2_ERR_ECP_BUFFER_TOO_SMALL:
    return (PSA_ERROR_BUFFER_TOO_SMALL);
  case MBEDTLS2_ERR_ECP_FEATURE_UNAVAILABLE:
    return (PSA_ERROR_NOT_SUPPORTED);
  case MBEDTLS2_ERR_ECP_SIG_LEN_MISMATCH:
  case MBEDTLS2_ERR_ECP_VERIFY_FAILED:
    return (PSA_ERROR_INVALID_SIGNATURE);
  case MBEDTLS2_ERR_ECP_ALLOC_FAILED:
    return (PSA_ERROR_INSUFFICIENT_MEMORY);
  case MBEDTLS2_ERR_ECP_RANDOM_FAILED:
    return (PSA_ERROR_INSUFFICIENT_ENTROPY);
  case MBEDTLS2_ERR_ECP_HW_ACCEL_FAILED:
    return (PSA_ERROR_HARDWARE_FAILURE);

  case MBEDTLS2_ERR_ERROR_CORRUPTION_DETECTED:
    return (PSA_ERROR_CORRUPTION_DETECTED);
...
#if defined(MBEDTLS2_PSA_BUILTIN_KEY_TYPE_ECC_KEY_PAIR) ||              \
    defined(MBEDTLS2_PSA_BUILTIN_KEY_TYPE_ECC_PUBLIC_KEY) ||            \
    defined(MBEDTLS2_PSA_BUILTIN_ALG_ECDSA) ||                          \
    defined(MBEDTLS2_PSA_BUILTIN_ALG_DETERMINISTIC_ECDSA) ||            \
    defined(MBEDTLS2_PSA_BUILTIN_ALG_ECDH)
mbedtls2_ecp_group_id
mbedtls2_ecc_group_of_psa(psa_ecc_family_t curve, size_t bits,
                                 int bits_is_sloppy) {
  switch (curve) {
  case PSA_ECC_FAMILY_SECP_R1:
    ...
    case 192:
      return (MBEDTLS2_ECP_DP_SECP192R1);
#endif
#if defined(PSA_WANT_ECC_SECP_R1_224)
    case 224:
      return (MBEDTLS2_ECP_DP_SECP224R1);
#endif
#if defined(PSA_WANT_ECC_SECP_R1_256)
    case 256:
      return (MBEDTLS2_ECP_DP_SECP256R1);
#endif
#if defined(PSA_WANT_ECC_SECP_R1_384)
    case 384:
      return (MBEDTLS2_ECP_DP_SECP384R1);
#endif
#if defined(PSA_WANT_ECC_SECP_R1_521)
    case 521:
      return (MBEDTLS2_ECP_DP_SECP521R1);
    case 528:
      if (bits_is_sloppy)
        return (MBEDTLS2_ECP_DP_SECP521R1);
      break;
  ...
  case PSA_ECC_FAMILY_BRAINPOOL_P_R1:
    ...
    case 256:
      return (MBEDTLS2_ECP_DP_BP256R1);
#endif
#if defined(PSA_WANT_ECC_BRAINPOOL_P_R1_384)
    case 384:
      return (MBEDTLS2_ECP_DP_BP384R1);
#endif
#if defined(PSA_WANT_ECC_BRAINPOOL_P_R1_512)
    case 512:
      return (MBEDTLS2_ECP_DP_BP512R1);
#endif
    }
    break;
  ...
  case PSA_ECC_FAMILY_MONTGOMERY:
    ...
    case 255:
      return (MBEDTLS2_ECP_DP_CURVE25519);
    case 256:
      if (bits_is_sloppy)
        return (MBEDTLS2_ECP_DP_CURVE25519);
      break;
    ...
    case 448:
      return (MBEDTLS2_ECP_DP_CURVE448);
#endif
    }
    break;
  ...
  case PSA_ECC_FAMILY_SECP_K1:
    ...
    case 192:
      return (MBEDTLS2_ECP_DP_SECP192K1);
#endif
#if defined(PSA_WANT_ECC_SECP_K1_224)
    case 224:
      return (MBEDTLS2_ECP_DP_SECP224K1);
#endif
#if defined(PSA_WANT_ECC_SECP_K1_256)
    case 256:
      return (MBEDTLS2_ECP_DP_SECP256K1);
#endif
    }
    break;
  }
  ...
  (void)bits_is_sloppy;
  return (MBEDTLS2_ECP_DP_NONE);
}
#endif /* defined(MBEDTLS2_PSA_BUILTIN_KEY_TYPE_ECC_KEY_PAIR) ||        \
          defined(MBEDTLS2_PSA_BUILTIN_KEY_TYPE_ECC_PUBLIC_KEY) ||      \
          defined(MBEDTLS2_PSA_BUILTIN_ALG_ECDSA) ||                    \
          defined(MBEDTLS2_PSA_BUILTIN_ALG_DETERMINISTIC_ECDSA) ||      \
          defined(MBEDTLS2_PSA_BUILTIN_ALG_ECDH) */
 ...
 */
MBEDTLS2_STATIC_TESTABLE psa_status_t
...
psa_status_t psa_allocate_buffer_to_slot(psa_key_slot_t *slot,
  ...
  slot->key.data = mbedtls2_calloc(1, buffer_length);
  if (slot->key.data == NULL)
    return (PSA_ERROR_INSUFFICIENT_MEMORY);
  ...
  if (key_type_is_raw_bytes(type)) {
    ...
    *key_buffer_length = data_length;
    ...
    if (PSA_KEY_TYPE_IS_ECC(type)) {
      return (mbedtls2_psa_ecp_import_key(attributes, data, data_length,
    ...
    if (PSA_KEY_TYPE_IS_RSA(type)) {
      return (mbedtls2_psa_rsa_import_key(attributes, data, data_length,
                                                 key_buffer, key_buffer_size,
                                                 key_buffer_length, bits));
    }
 ...
 */
static psa_status_t
psa_restrict_key_policy(psa_key_type_t key_type, psa_key_policy_t *policy,
...
static psa_status_t psa_get_and_lock_key_slot_with_policy(
    mbedtls2_svc_key_id_t key, psa_key_slot_t **p_slot,
...
psa_status_t psa_remove_key_data_from_memory(psa_key_slot_t *slot) {
  ...
  if (slot->key.data != NULL)
    mbedtls2_platform_zeroize(slot->key.data, slot->key.bytes);

  mbedtls2_free(slot->key.data);
  slot->key.data = NULL;
  slot->key.bytes = 0;
...
psa_status_t psa_wipe_key_slot(psa_key_slot_t *slot) {
   ...
   * call MBEDTLS2_PARAM_FAILED that may terminate execution (if called
   * as part of the execution of a test suite this will stop the test suite
   * execution).
   */
  if (slot->lock_count != 1) {
#ifdef MBEDTLS2_CHECK_PARAMS
    MBEDTLS2_PARAM_FAILED(slot->lock_count == 1);
#endif
...
psa_status_t psa_destroy_key(mbedtls2_svc_key_id_t key) {
  psa_key_slot_t *slot;
...
#endif /* defined(MBEDTLS2_PSA_CRYPTO_STORAGE_C) */
...
exit:
  ...
  return (overall_status);
    ...
    defined(MBEDTLS2_PSA_BUILTIN_KEY_TYPE_RSA_PUBLIC_KEY)
static psa_status_t
psa_get_rsa_public_exponent(const mbedtls2_rsa_context *rsa,
                            psa_key_attributes_t *attributes) {
  mbedtls2_mpi mpi;
  int ret = MBEDTLS2_ERR_ERROR_CORRUPTION_DETECTED;
  uint8_t *buffer = NULL;
  size_t buflen;
  mbedtls2_mpi_init(&mpi);

  ret = mbedtls2_rsa_export(rsa, NULL, NULL, NULL, NULL, &mpi);
  if (ret != 0)
    goto exit;
  if (mbedtls2_mpi_cmp_int(&mpi, 65537) == 0) {
    /* It's the default value, which is reported as an empty string,
     * so there's nothing to do. */
    goto exit;
  }

  buflen = mbedtls2_mpi_size(&mpi);
  buffer = mbedtls2_calloc(1, buflen);
  if (buffer == NULL) {
    ret = MBEDTLS2_ERR_MPI_ALLOC_FAILED;
    goto exit;
  }
  ret = mbedtls2_mpi_write_binary(&mpi, buffer, buflen);
  if (ret != 0)
    goto exit;
 ...
 */
psa_status_t psa_get_key_attributes(mbedtls2_svc_key_id_t key,
                                    psa_key_attributes_t *attributes) {
  psa_status_t status = PSA_ERROR_CORRUPTION_DETECTED;
  ...
  attributes->core.flags &= (MBEDTLS2_PSA_KA_MASK_EXTERNAL_ONLY |
                             MBEDTLS2_PSA_KA_MASK_DUAL_USE);
...
psa_status_t psa_get_key_slot_number(const psa_key_attributes_t *attributes,
  ...
  if (attributes->core.flags & MBEDTLS2_PSA_KA_FLAG_HAS_SLOT_NUMBER) {
...
psa_status_t psa_export_key_internal(const psa_key_attributes_t *attributes,
  ...
  if (key_type_is_raw_bytes(type) || PSA_KEY_TYPE_IS_RSA(type) ||
    ...
    return (psa_export_key_buffer_internal(key_buffer, key_buffer_size, data,
...
psa_status_t psa_export_key(mbedtls2_svc_key_id_t key, uint8_t *data,
                            size_t data_size, size_t *data_length) {
  psa_status_t status = PSA_ERROR_CORRUPTION_DETECTED;
  psa_status_t unlock_status = PSA_ERROR_CORRUPTION_DETECTED;
  psa_key_slot_t *slot;
...
#if defined(MBEDTLS2_PSA_BUILTIN_KEY_TYPE_RSA_KEY_PAIR) ||              \
    defined(MBEDTLS2_PSA_BUILTIN_KEY_TYPE_RSA_PUBLIC_KEY)
      return (mbedtls2_psa_rsa_export_public_key(
...
#if defined(MBEDTLS2_PSA_BUILTIN_KEY_TYPE_ECC_KEY_PAIR) ||              \
    defined(MBEDTLS2_PSA_BUILTIN_KEY_TYPE_ECC_PUBLIC_KEY)
      return (mbedtls2_psa_ecp_export_public_key(
          attributes, key_buffer, key_buffer_size, data, data_size,
          data_length));
#else
...
psa_status_t psa_export_public_key(mbedtls2_svc_key_id_t key,
...
static_assert((MBEDTLS2_PSA_KA_MASK_EXTERNAL_ONLY &
               MBEDTLS2_PSA_KA_MASK_DUAL_USE) == 0,
              "One or more key attribute flag is listed as both external-only "
              "and dual-use");
static_assert((PSA_KA_MASK_INTERNAL_ONLY &
               MBEDTLS2_PSA_KA_MASK_DUAL_USE) == 0,
              "One or more key attribute flag is listed as both internal-only "
              "and dual-use");
static_assert((PSA_KA_MASK_INTERNAL_ONLY &
               MBEDTLS2_PSA_KA_MASK_EXTERNAL_ONLY) == 0,
              "One or more key attribute flag is listed as both internal-only "
              "and external-only");
#endif
...
static psa_status_t psa_validate_key_policy(const psa_key_policy_t *policy) {
  if ((policy->usage &
       ~(PSA_KEY_USAGE_EXPORT | PSA_KEY_USAGE_COPY | PSA_KEY_USAGE_ENCRYPT |
         ...
         PSA_KEY_USAGE_VERIFY_HASH | PSA_KEY_USAGE_DERIVE)) != 0)
    return (PSA_ERROR_INVALID_ARGUMENT);
...
psa_validate_key_attributes(const psa_key_attributes_t *attributes,
  ...
  mbedtls2_svc_key_id_t key = psa_get_key_id(attributes);
  ...
  if (PSA_KEY_LIFETIME_IS_VOLATILE(lifetime)) {
    if (MBEDTLS2_SVC_KEY_ID_GET_KEY_ID(key) != 0)
      return (PSA_ERROR_INVALID_ARGUMENT);
  } else {
  ...
  if (attributes->core.flags & ~(MBEDTLS2_PSA_KA_MASK_EXTERNAL_ONLY |
                                 MBEDTLS2_PSA_KA_MASK_DUAL_USE))
    return (PSA_ERROR_INVALID_ARGUMENT);
...
static psa_status_t psa_start_key_creation(
    psa_key_creation_method_t method, const psa_key_attributes_t *attributes,
    psa_key_slot_t **p_slot, psa_se_drv_table_entry_t **p_drv) {
  psa_status_t status;
  ...
  *p_drv = NULL;
   ...
   * may have set. */
  slot->attr.flags &= ~MBEDTLS2_PSA_KA_MASK_EXTERNAL_ONLY;
  ...
  if (*p_drv != NULL) {
    ...
    status = psa_copy_key_material_into_slot(slot, (uint8_t *)(&slot_number),
                                             sizeof(slot_number));
  }
...
static psa_status_t psa_finish_key_creation(psa_key_slot_t *slot,
  ...
  if (!PSA_KEY_LIFETIME_IS_VOLATILE(slot->attr.lifetime)) {
    ...
    if (driver != NULL) {
      ...
      status =
          psa_save_persistent_key(&slot->attr, (uint8_t *)&data, sizeof(data));
    } else
#endif /* MBEDTLS2_PSA_CRYPTO_SE_C */
    {
      ...
      status =
          psa_save_persistent_key(&slot->attr, slot->key.data, slot->key.bytes);
    }
  }
#endif /* defined(MBEDTLS2_PSA_CRYPTO_STORAGE_C) */
...
psa_validate_optional_attributes(const psa_key_slot_t *slot,
  ...
  if (attributes->domain_parameters_size != 0) {
    ...
    if (PSA_KEY_TYPE_IS_RSA(slot->attr.type)) {
      mbedtls2_rsa_context *rsa = NULL;
      mbedtls2_mpi actual, required;
      int ret = MBEDTLS2_ERR_ERROR_CORRUPTION_DETECTED;

      psa_status_t status = mbedtls2_psa_rsa_load_representation(
          slot->attr.type, slot->key.data, slot->key.bytes, &rsa);
      if (status != PSA_SUCCESS)
        return (status);

      mbedtls2_mpi_init(&actual);
      mbedtls2_mpi_init(&required);
      ret = mbedtls2_rsa_export(rsa, NULL, NULL, NULL, NULL, &actual);
      mbedtls2_rsa_free(rsa);
      mbedtls2_free(rsa);
      if (ret != 0)
        goto rsa_exit;
      ret = mbedtls2_mpi_read_binary(&required,
                                            attributes->domain_parameters,
                                            attributes->domain_parameters_size);
      if (ret != 0)
        goto rsa_exit;
      if (mbedtls2_mpi_cmp_mpi(&actual, &required) != 0)
        ret = MBEDTLS2_ERR_RSA_BAD_INPUT_DATA;
    rsa_exit:
      mbedtls2_mpi_free(&actual);
      mbedtls2_mpi_free(&required);
      if (ret != 0)
        return (mbedtls2_to_psa_error(ret));
    } else
#endif /* defined(MBEDTLS2_PSA_BUILTIN_KEY_TYPE_RSA_KEY_PAIR) ||        \
...
#if defined(MBEDTLS2_PSA_CRYPTO_SE_C)
psa_status_t
mbedtls2_psa_register_se_key(const psa_key_attributes_t *attributes) {
  psa_status_t status;
  psa_key_slot_t *slot = NULL;
  psa_se_drv_table_entry_t *driver = NULL;
  mbedtls2_svc_key_id_t key = MBEDTLS2_SVC_KEY_ID_INIT;
  ...
  status = psa_start_key_creation(PSA_KEY_CREATION_REGISTER, attributes, &slot,
                                  &driver);
  if (status != PSA_SUCCESS)
    goto exit;
...
psa_status_t psa_copy_key(mbedtls2_svc_key_id_t source_key,
                          const psa_key_attributes_t *specified_attributes,
                          mbedtls2_svc_key_id_t *target_key) {
  psa_status_t status = PSA_ERROR_CORRUPTION_DETECTED;
  psa_status_t unlock_status = PSA_ERROR_CORRUPTION_DETECTED;
  ...
  *target_key = MBEDTLS2_SVC_KEY_ID_INIT;
...
psa_status_t psa_hash_verify(psa_hash_operation_t *operation,
  ...
  if (mbedtls2_psa_safer_memcmp(hash, actual_hash, actual_hash_length) !=
      0)
    status = PSA_ERROR_INVALID_SIGNATURE;

exit:
  mbedtls2_platform_zeroize(actual_hash, sizeof(actual_hash));
  if (status != PSA_SUCCESS)
    psa_hash_abort(operation);
...
psa_status_t psa_hash_compare(psa_algorithm_t alg, const uint8_t *input,
  ...
  psa_status_t status =
      psa_driver_wrapper_hash_compute(alg, input, input_length, actual_hash,
...
psa_status_t psa_mac_sign_finish(psa_mac_operation_t *operation, uint8_t *mac,
  ...
  status = psa_driver_wrapper_mac_sign_finish(operation, mac,
                                              operation->mac_size, mac_length);
...
static psa_status_t psa_mac_compute_internal(mbedtls2_svc_key_id_t key,
                                             psa_algorithm_t alg,
                                             const uint8_t *input,
                                             size_t input_length, uint8_t *mac,
                                             size_t mac_size,
                                             size_t *mac_length, int is_sign) {
  psa_status_t status = PSA_ERROR_CORRUPTION_DETECTED;
  psa_status_t unlock_status = PSA_ERROR_CORRUPTION_DETECTED;
  psa_key_slot_t *slot;
  ...
  status = psa_driver_wrapper_mac_compute(
      &attributes, slot->key.data, slot->key.bytes, alg, input, input_length,
...
psa_status_t psa_mac_compute(mbedtls2_svc_key_id_t key,
                             psa_algorithm_t alg, const uint8_t *input,
                             size_t input_length, uint8_t *mac, size_t mac_size,
                             size_t *mac_length) {
  return (psa_mac_compute_internal(key, alg, input, input_length, mac, mac_size,
                                   mac_length, 1));
}

psa_status_t psa_mac_verify(mbedtls2_svc_key_id_t key,
                            psa_algorithm_t alg, const uint8_t *input,
                            size_t input_length, const uint8_t *mac,
                            size_t mac_length) {
  psa_status_t status = PSA_ERROR_CORRUPTION_DETECTED;
  ...
  status = psa_mac_compute_internal(key, alg, input, input_length, actual_mac,
                                    sizeof(actual_mac), &actual_mac_length, 0);
  if (status != PSA_SUCCESS)
    goto exit;
  ...
  if (mbedtls2_psa_safer_memcmp(mac, actual_mac, actual_mac_length) !=
      0) {
    status = PSA_ERROR_INVALID_SIGNATURE;
    goto exit;
  }
...
exit:
  mbedtls2_platform_zeroize(actual_mac, sizeof(actual_mac));
...
static psa_status_t psa_sign_internal(mbedtls2_svc_key_id_t key,
                                      int input_is_message, psa_algorithm_t alg,
                                      const uint8_t *input, size_t input_length,
...
static psa_status_t
psa_verify_internal(mbedtls2_svc_key_id_t key, int input_is_message,
                    psa_algorithm_t alg, const uint8_t *input,
...
psa_status_t psa_sign_message_builtin(const psa_key_attributes_t *attributes,
  ...
  if (PSA_ALG_IS_SIGN_HASH(alg)) {
    ...
    status = psa_driver_wrapper_hash_compute(PSA_ALG_SIGN_GET_HASH(alg), input,
                                             input_length, hash, sizeof(hash),
                                             &hash_length);

    if (status != PSA_SUCCESS)
      return status;

    return psa_driver_wrapper_sign_hash(attributes, key_buffer, key_buffer_size,
...
psa_status_t psa_sign_message(mbedtls2_svc_key_id_t key,
                              psa_algorithm_t alg, const uint8_t *input,
                              size_t input_length, uint8_t *signature,
...
psa_status_t psa_verify_message(mbedtls2_svc_key_id_t key,
                                psa_algorithm_t alg, const uint8_t *input,
                                size_t input_length, const uint8_t *signature,
                                size_t signature_length) {
...
psa_status_t psa_sign_hash_builtin(const psa_key_attributes_t *attributes,
  ...
  if (attributes->core.type == PSA_KEY_TYPE_RSA_KEY_PAIR) {
    ...
    defined(MBEDTLS2_PSA_BUILTIN_ALG_RSA_PSS)
      return (mbedtls2_psa_rsa_sign_hash(
          attributes, key_buffer, key_buffer_size, alg, hash, hash_length,
          signature, signature_size, signature_length));
...
#if defined(MBEDTLS2_PSA_BUILTIN_ALG_ECDSA) ||                          \
    defined(MBEDTLS2_PSA_BUILTIN_ALG_DETERMINISTIC_ECDSA)
      return (mbedtls2_psa_ecdsa_sign_hash(
          attributes, key_buffer, key_buffer_size, alg, hash, hash_length,
          signature, signature_size, signature_length));
#endif /* defined(MBEDTLS2_PSA_BUILTIN_ALG_ECDSA) ||                    \
        * defined(MBEDTLS2_PSA_BUILTIN_ALG_DETERMINISTIC_ECDSA) */
    } else {
      return (PSA_ERROR_INVALID_ARGUMENT);
    }
...
psa_status_t psa_sign_hash(mbedtls2_svc_key_id_t key,
...
#if defined(MBEDTLS2_PSA_BUILTIN_ALG_RSA_PKCS1V15_SIGN) ||              \
    defined(MBEDTLS2_PSA_BUILTIN_ALG_RSA_PSS)
      return (mbedtls2_psa_rsa_verify_hash(
          attributes, key_buffer, key_buffer_size, alg, hash, hash_length,
          signature, signature_length));
#endif /* defined(MBEDTLS2_PSA_BUILTIN_ALG_RSA_PKCS1V15_SIGN) ||        \
        * defined(MBEDTLS2_PSA_BUILTIN_ALG_RSA_PSS) */
...
#if defined(MBEDTLS2_PSA_BUILTIN_ALG_ECDSA) ||                          \
    defined(MBEDTLS2_PSA_BUILTIN_ALG_DETERMINISTIC_ECDSA)
      return (mbedtls2_psa_ecdsa_verify_hash(
          attributes, key_buffer, key_buffer_size, alg, hash, hash_length,
          signature, signature_length));
#endif /* defined(MBEDTLS2_PSA_BUILTIN_ALG_ECDSA) ||                    \
        * defined(MBEDTLS2_PSA_BUILTIN_ALG_DETERMINISTIC_ECDSA) */
...
psa_status_t psa_verify_hash(mbedtls2_svc_key_id_t key,
                             psa_algorithm_t alg, const uint8_t *hash,
...
#if defined(MBEDTLS2_PSA_BUILTIN_ALG_RSA_OAEP)
static void psa_rsa_oaep_set_padding_mode(psa_algorithm_t alg,
  ...
  mbedtls2_md_type_t md_alg = mbedtls2_md_get_type(md_info);
  mbedtls2_rsa_set_padding(rsa, MBEDTLS2_RSA_PKCS_V21, md_alg);
}
#endif /* defined(MBEDTLS2_PSA_BUILTIN_ALG_RSA_OAEP) */

psa_status_t psa_asymmetric_encrypt(mbedtls2_svc_key_id_t key,
                                    psa_algorithm_t alg, const uint8_t *input,
  ...
  *output_length = 0;
  ...
  if (PSA_KEY_TYPE_IS_RSA(slot->attr.type)) {
    ...
    if (output_size < mbedtls2_rsa_get_len(rsa)) {
      status = PSA_ERROR_BUFFER_TOO_SMALL;
      goto rsa_exit;
    }
...
#if defined(MBEDTLS2_PSA_BUILTIN_ALG_RSA_PKCS1V15_CRYPT)
      status = mbedtls2_to_psa_error(mbedtls2_rsa_pkcs1_encrypt(
          rsa, mbedtls2_psa_get_random, MBEDTLS2_PSA_RANDOM_STATE,
          MBEDTLS2_RSA_PUBLIC, input_length, input, output));
#else
      status = PSA_ERROR_NOT_SUPPORTED;
#endif /* MBEDTLS2_PSA_BUILTIN_ALG_RSA_PKCS1V15_CRYPT */
    } else if (PSA_ALG_IS_RSA_OAEP(alg)) {
#if defined(MBEDTLS2_PSA_BUILTIN_ALG_RSA_OAEP)
      psa_rsa_oaep_set_padding_mode(alg, rsa);
      status =
          mbedtls2_to_psa_error(mbedtls2_rsa_rsaes_oaep_encrypt(
              rsa, mbedtls2_psa_get_random,
              MBEDTLS2_PSA_RANDOM_STATE, MBEDTLS2_RSA_PUBLIC,
              salt, salt_length, input_length, input, output));
#else
      status = PSA_ERROR_NOT_SUPPORTED;
#endif /* MBEDTLS2_PSA_BUILTIN_ALG_RSA_OAEP */
    } else {
      status = PSA_ERROR_INVALID_ARGUMENT;
    }
#if defined(MBEDTLS2_PSA_BUILTIN_ALG_RSA_PKCS1V15_CRYPT) ||             \
  ...
  rsa_exit:
    if (status == PSA_SUCCESS)
      *output_length = mbedtls2_rsa_get_len(rsa);
...
psa_status_t psa_asymmetric_decrypt(mbedtls2_svc_key_id_t key,
                                    psa_algorithm_t alg, const uint8_t *input,
                                    size_t input_length, const uint8_t *salt,
                                    size_t salt_length, uint8_t *output,
                                    size_t output_size, size_t *output_length) {
  ...
  *output_length = 0;
  ...
  if (slot->attr.type == PSA_KEY_TYPE_RSA_KEY_PAIR) {
    ...
    if (input_length != mbedtls2_rsa_get_len(rsa)) {
      status = PSA_ERROR_INVALID_ARGUMENT;
      goto rsa_exit;
    }
#endif /* defined(MBEDTLS2_PSA_BUILTIN_ALG_RSA_PKCS1V15_CRYPT) ||       \
    ...
    if (alg == PSA_ALG_RSA_PKCS1V15_CRYPT) {
#if defined(MBEDTLS2_PSA_BUILTIN_ALG_RSA_PKCS1V15_CRYPT)
      status = mbedtls2_to_psa_error(mbedtls2_rsa_pkcs1_decrypt(
          rsa, mbedtls2_psa_get_random, MBEDTLS2_PSA_RANDOM_STATE,
          MBEDTLS2_RSA_PRIVATE, output_length, input, output,
          output_size));
#else
      status = PSA_ERROR_NOT_SUPPORTED;
#endif /* MBEDTLS2_PSA_BUILTIN_ALG_RSA_PKCS1V15_CRYPT */
      ...
      psa_rsa_oaep_set_padding_mode(alg, rsa);
      status =
          mbedtls2_to_psa_error(mbedtls2_rsa_rsaes_oaep_decrypt(
              rsa, mbedtls2_psa_get_random,
              MBEDTLS2_PSA_RANDOM_STATE, MBEDTLS2_RSA_PRIVATE,
              salt, salt_length, output_length, input, output, output_size));
#else
      status = PSA_ERROR_NOT_SUPPORTED;
#endif /* MBEDTLS2_PSA_BUILTIN_ALG_RSA_OAEP */
    } else {
...
static psa_status_t
psa_cipher_setup(psa_cipher_operation_t *operation,
                 mbedtls2_svc_key_id_t key, psa_algorithm_t alg,
                 mbedtls2_operation_t cipher_operation) {
  psa_status_t status = PSA_ERROR_CORRUPTION_DETECTED;
  psa_status_t unlock_status = PSA_ERROR_CORRUPTION_DETECTED;
  psa_key_slot_t *slot = NULL;
  psa_key_usage_t usage =
      (cipher_operation == MBEDTLS2_ENCRYPT ? PSA_KEY_USAGE_ENCRYPT
  ...
  if (cipher_operation == MBEDTLS2_ENCRYPT)
...
psa_status_t psa_cipher_encrypt_setup(psa_cipher_operation_t *operation,
                                      mbedtls2_svc_key_id_t key,
                                      psa_algorithm_t alg) {
  return (psa_cipher_setup(operation, key, alg, MBEDTLS2_ENCRYPT));
}

psa_status_t psa_cipher_decrypt_setup(psa_cipher_operation_t *operation,
                                      mbedtls2_svc_key_id_t key,
                                      psa_algorithm_t alg) {
  return (psa_cipher_setup(operation, key, alg, MBEDTLS2_DECRYPT));
}
...
psa_status_t psa_cipher_generate_iv(psa_cipher_operation_t *operation,
  ...
  status =
      psa_driver_wrapper_cipher_set_iv(operation, local_iv, default_iv_length);
...
psa_status_t psa_cipher_encrypt(mbedtls2_svc_key_id_t key,
                                psa_algorithm_t alg, const uint8_t *input,
  ...
  status = psa_driver_wrapper_cipher_encrypt(
      &attributes, slot->key.data, slot->key.bytes, alg, local_iv,
      default_iv_length, input, input_length, output + default_iv_length,
...
psa_status_t psa_cipher_decrypt(mbedtls2_svc_key_id_t key,
                                psa_algorithm_t alg, const uint8_t *input,
                                size_t input_length, uint8_t *output,
                                size_t output_size, size_t *output_length) {
  psa_status_t status = PSA_ERROR_CORRUPTION_DETECTED;
...
psa_status_t psa_aead_encrypt(mbedtls2_svc_key_id_t key,
...
psa_status_t psa_aead_decrypt(mbedtls2_svc_key_id_t key,
                              psa_algorithm_t alg, const uint8_t *nonce,
                              size_t nonce_length,
                              const uint8_t *additional_data,
                              size_t additional_data_length,
...
#if defined(MBEDTLS2_PSA_BUILTIN_ALG_HKDF) ||                           \
    defined(MBEDTLS2_PSA_BUILTIN_ALG_TLS12_PRF) ||                      \
    defined(MBEDTLS2_PSA_BUILTIN_ALG_TLS12_PSK_TO_MS)
...
psa_key_derivation_abort(psa_key_derivation_operation_t *operation) {
  ...
  if (kdf_alg == 0) {
    ...
    mbedtls2_free(operation->ctx.hkdf.info);
    status = psa_mac_abort(&operation->ctx.hkdf.hmac);
  } else
#endif /* defined(MBEDTLS2_PSA_BUILTIN_ALG_HKDF */
#if defined(MBEDTLS2_PSA_BUILTIN_ALG_TLS12_PRF) ||                      \
    defined(MBEDTLS2_PSA_BUILTIN_ALG_TLS12_PSK_TO_MS)
      if (PSA_ALG_IS_TLS12_PRF(kdf_alg) ||
          /* TLS-1.2 PSK-to-MS KDF uses the same core as TLS-1.2 PRF */
          PSA_ALG_IS_TLS12_PSK_TO_MS(kdf_alg)) {
    if (operation->ctx.tls12_prf.secret != NULL) {
      mbedtls2_platform_zeroize(operation->ctx.tls12_prf.secret,
                                       operation->ctx.tls12_prf.secret_length);
      mbedtls2_free(operation->ctx.tls12_prf.secret);
    }

    if (operation->ctx.tls12_prf.seed != NULL) {
      mbedtls2_platform_zeroize(operation->ctx.tls12_prf.seed,
                                       operation->ctx.tls12_prf.seed_length);
      mbedtls2_free(operation->ctx.tls12_prf.seed);
    }

    if (operation->ctx.tls12_prf.label != NULL) {
      mbedtls2_platform_zeroize(operation->ctx.tls12_prf.label,
                                       operation->ctx.tls12_prf.label_length);
      mbedtls2_free(operation->ctx.tls12_prf.label);
    }

    status = PSA_SUCCESS;

    /* We leave the fields Ai and output_block to be erased safely by the
     * mbedtls2_platform_zeroize() in the end of this function. */
  } else
#endif /* defined(MBEDTLS2_PSA_BUILTIN_ALG_TLS12_PRF) ||                \
        * defined(MBEDTLS2_PSA_BUILTIN_ALG_TLS12_PSK_TO_MS) */
  {
    status = PSA_ERROR_BAD_STATE;
  }
  mbedtls2_platform_zeroize(operation, sizeof(*operation));
  return (status);
}
...
psa_key_derivation_hkdf_read(psa_hkdf_key_derivation_t *hkdf,
                             psa_algorithm_t hash_alg, uint8_t *output,
                             size_t output_length) {
  ...
  while (output_length != 0) {
    ...
    if (status != PSA_SUCCESS)
      return (status);
    status =
        psa_mac_sign_finish(&hkdf->hmac, hkdf->output_block,
                            sizeof(hkdf->output_block), &hmac_output_length);
    if (status != PSA_SUCCESS)
      return (status);
  }
...
#endif /* MBEDTLS2_PSA_BUILTIN_ALG_HKDF */
...
#endif /* MBEDTLS2_PSA_BUILTIN_ALG_TLS12_PRF ||                         \
        * MBEDTLS2_PSA_BUILTIN_ALG_TLS12_PSK_TO_MS */
...
#if defined(MBEDTLS2_PSA_BUILTIN_KEY_TYPE_DES)
static void psa_des_set_key_parity(uint8_t *data, size_t data_size) {
  if (data_size >= 8)
    mbedtls2_des_key_set_parity(data);
  if (data_size >= 16)
    mbedtls2_des_key_set_parity(data + 8);
  if (data_size >= 24)
    mbedtls2_des_key_set_parity(data + 16);
}
#endif /* MBEDTLS2_PSA_BUILTIN_KEY_TYPE_DES */

static psa_status_t
psa_generate_derived_key_internal(psa_key_slot_t *slot, size_t bits,
  ...
  status =
      psa_driver_wrapper_import_key(&attributes, data, bytes, slot->key.data,
...
#endif
#if defined(MBEDTLS2_PSA_BUILTIN_ALG_TLS12_PSK_TO_MS)
...
static psa_status_t psa_hkdf_input(psa_hkdf_key_derivation_t *hkdf,
  ...
  case PSA_KEY_DERIVATION_INPUT_SALT:
    if (hkdf->state != HKDF_STATE_INIT)
      ...
      status = psa_key_derivation_start_hmac(&hkdf->hmac, hash_alg, data,
                                             data_length);
      if (status != PSA_SUCCESS)
        return (status);
  ...
  case PSA_KEY_DERIVATION_INPUT_SECRET:
    ...
    if (status != PSA_SUCCESS)
      return (status);
    status = psa_mac_sign_finish(&hkdf->hmac, hkdf->prk, sizeof(hkdf->prk),
                                 &data_length);
    if (status != PSA_SUCCESS)
      return (status);
  ...
  case PSA_KEY_DERIVATION_INPUT_INFO:
    ...
    if (data_length != 0) {
      hkdf->info = mbedtls2_calloc(1, data_length);
      if (hkdf->info == NULL)
        return (PSA_ERROR_INSUFFICIENT_MEMORY);
...
static psa_status_t psa_tls12_prf_set_seed(psa_tls12_prf_key_derivation_t *prf,
  ...
  if (data_length != 0) {
    prf->seed = mbedtls2_calloc(1, data_length);
    if (prf->seed == NULL)
      return (PSA_ERROR_INSUFFICIENT_MEMORY);
...
static psa_status_t psa_tls12_prf_set_key(psa_tls12_prf_key_derivation_t *prf,
  ...
  if (data_length != 0) {
    prf->secret = mbedtls2_calloc(1, data_length);
    if (prf->secret == NULL)
      return (PSA_ERROR_INSUFFICIENT_MEMORY);
...
static psa_status_t psa_tls12_prf_set_label(psa_tls12_prf_key_derivation_t *prf,
  ...
  if (data_length != 0) {
    prf->label = mbedtls2_calloc(1, data_length);
    if (prf->label == NULL)
      return (PSA_ERROR_INSUFFICIENT_MEMORY);
...
psa_tls12_prf_psk_to_ms_set_key(psa_tls12_prf_key_derivation_t *prf,
  ...
  *cur++ = MBEDTLS2_BYTE_1(data_length);
  *cur++ = MBEDTLS2_BYTE_0(data_length);
  ...
  *cur++ = pms[1];
  ...
  mbedtls2_platform_zeroize(pms, sizeof(pms));
  return (status);
}
...
#endif /* MBEDTLS2_PSA_BUILTIN_ALG_TLS12_PSK_TO_MS */
...
static psa_status_t psa_key_derivation_input_internal(
    ...
    psa_key_type_t key_type, const uint8_t *data, size_t data_length) {
  psa_status_t status;
  psa_algorithm_t kdf_alg = psa_key_derivation_get_kdf_alg(operation);
  ...
  if (PSA_ALG_IS_HKDF(kdf_alg)) {
    status =
        psa_hkdf_input(&operation->ctx.hkdf, PSA_ALG_HKDF_GET_HASH(kdf_alg),
      ...
      if (PSA_ALG_IS_TLS12_PRF(kdf_alg)) {
    status =
        psa_tls12_prf_input(&operation->ctx.tls12_prf, step, data, data_length);
  } else
#endif /* MBEDTLS2_PSA_BUILTIN_ALG_TLS12_PRF */
#if defined(MBEDTLS2_PSA_BUILTIN_ALG_TLS12_PSK_TO_MS)
      if (PSA_ALG_IS_TLS12_PSK_TO_MS(kdf_alg)) {
...
psa_key_derivation_input_bytes(psa_key_derivation_operation_t *operation,
                               psa_key_derivation_step_t step,
                               const uint8_t *data, size_t data_length) {
  return (psa_key_derivation_input_internal(operation, step, PSA_KEY_TYPE_NONE,
                                            data, data_length));
}
...
#if defined(MBEDTLS2_PSA_BUILTIN_ALG_ECDH)
static psa_status_t
psa_key_agreement_ecdh(const uint8_t *peer_key, size_t peer_key_length,
                       const mbedtls2_ecp_keypair *our_key,
                       uint8_t *shared_secret, size_t shared_secret_size,
                       size_t *shared_secret_length) {
  mbedtls2_ecp_keypair *their_key = NULL;
  mbedtls2_ecdh_context ecdh;
  psa_status_t status;
  size_t bits = 0;
  psa_ecc_family_t curve =
      mbedtls2_ecc_group_to_psa(our_key->grp.id, &bits);
  mbedtls2_ecdh_init(&ecdh);

  status = mbedtls2_psa_ecp_load_representation(
      PSA_KEY_TYPE_ECC_PUBLIC_KEY(curve), bits, peer_key, peer_key_length,
      &their_key);
  if (status != PSA_SUCCESS)
    goto exit;

  status = mbedtls2_to_psa_error(mbedtls2_ecdh_get_params(
      &ecdh, their_key, MBEDTLS2_ECDH_THEIRS));
  if (status != PSA_SUCCESS)
    goto exit;
  status = mbedtls2_to_psa_error(mbedtls2_ecdh_get_params(
      &ecdh, our_key, MBEDTLS2_ECDH_OURS));
  if (status != PSA_SUCCESS)
    goto exit;

  status = mbedtls2_to_psa_error(mbedtls2_ecdh_calc_secret(
      &ecdh, shared_secret_length, shared_secret, shared_secret_size,
      mbedtls2_psa_get_random, MBEDTLS2_PSA_RANDOM_STATE));
  if (status != PSA_SUCCESS)
    goto exit;
...
exit:
  if (status != PSA_SUCCESS)
    mbedtls2_platform_zeroize(shared_secret, shared_secret_size);
  mbedtls2_ecdh_free(&ecdh);
  mbedtls2_ecp_keypair_free(their_key);
  mbedtls2_free(their_key);

  return (status);
}
#endif /* MBEDTLS2_PSA_BUILTIN_ALG_ECDH */

#define PSA_KEY_AGREEMENT_MAX_SHARED_SECRET_SIZE MBEDTLS2_ECP_MAX_BYTES

static psa_status_t psa_key_agreement_raw_internal(
    psa_algorithm_t alg, psa_key_slot_t *private_key, const uint8_t *peer_key,
  ...
  case PSA_ALG_ECDH:
    if (!PSA_KEY_TYPE_IS_ECC_KEY_PAIR(private_key->attr.type))
      return (PSA_ERROR_INVALID_ARGUMENT);
    mbedtls2_ecp_keypair *ecp = NULL;
    psa_status_t status = mbedtls2_psa_ecp_load_representation(
        private_key->attr.type, private_key->attr.bits, private_key->key.data,
        private_key->key.bytes, &ecp);
    if (status != PSA_SUCCESS)
      return (status);
    status =
        psa_key_agreement_ecdh(peer_key, peer_key_length, ecp, shared_secret,
                               shared_secret_size, shared_secret_length);
    mbedtls2_ecp_keypair_free(ecp);
    mbedtls2_free(ecp);
    return (status);
#endif /* MBEDTLS2_PSA_BUILTIN_ALG_ECDH */
  default:
...
psa_key_agreement_internal(psa_key_derivation_operation_t *operation,
  ...
  status = psa_key_agreement_raw_internal(
      ka_alg, private_key, peer_key, peer_key_length, shared_secret,
...
exit:
  mbedtls2_platform_zeroize(shared_secret, shared_secret_length);
  return (status);
}

psa_status_t psa_key_derivation_key_agreement(
    psa_key_derivation_operation_t *operation, psa_key_derivation_step_t step,
    mbedtls2_svc_key_id_t private_key, const uint8_t *peer_key,
    size_t peer_key_length) {
  psa_status_t status = PSA_ERROR_CORRUPTION_DETECTED;
  psa_status_t unlock_status = PSA_ERROR_CORRUPTION_DETECTED;
  psa_key_slot_t *slot;
...
psa_status_t psa_raw_key_agreement(psa_algorithm_t alg,
                                   mbedtls2_svc_key_id_t private_key,
  ...
  status = psa_key_agreement_raw_internal(alg, slot, peer_key, peer_key_length,
                                          output, output_size, output_length);
 ...
 */
static void
mbedtls2_psa_random_init(mbedtls2_psa_random_context_t *rng) {
#if defined(MBEDTLS2_PSA_CRYPTO_EXTERNAL_RNG)
  memset(rng, 0, sizeof(*rng));
#else /* MBEDTLS2_PSA_CRYPTO_EXTERNAL_RNG */

  /* Set default configuration if
   * mbedtls2_psa_crypto_configure_entropy_sources() hasn't been called.
   */
  if (rng->entropy_init == NULL)
    rng->entropy_init = mbedtls2_entropy_init;
  if (rng->entropy_free == NULL)
    rng->entropy_free = mbedtls2_entropy_free;
  ...
  mbedtls2_entropy_add_source(&rng->entropy,
                                     mbedtls2_nv_seed_poll, NULL,
                                     MBEDTLS2_ENTROPY_BLOCK_SIZE,
                                     MBEDTLS2_ENTROPY_SOURCE_STRONG);
#endif

  mbedtls2_psa_drbg_init(MBEDTLS2_PSA_RANDOM_STATE);
 ...
 */
static void
mbedtls2_psa_random_free(mbedtls2_psa_random_context_t *rng) {
#if defined(MBEDTLS2_PSA_CRYPTO_EXTERNAL_RNG)
  memset(rng, 0, sizeof(*rng));
#else  /* MBEDTLS2_PSA_CRYPTO_EXTERNAL_RNG */
  mbedtls2_psa_drbg_free(MBEDTLS2_PSA_RANDOM_STATE);
 ...
 */
static psa_status_t
mbedtls2_psa_random_seed(mbedtls2_psa_random_context_t *rng) {
#if defined(MBEDTLS2_PSA_CRYPTO_EXTERNAL_RNG)
  ...
  int ret = mbedtls2_psa_drbg_seed(&rng->entropy, drbg_seed,
                                          sizeof(drbg_seed) - 1);
  return mbedtls2_to_psa_error(ret);
#endif /* MBEDTLS2_PSA_CRYPTO_EXTERNAL_RNG */
}
...
psa_status_t psa_generate_random(uint8_t *output, size_t output_size) {
  ...
  psa_status_t status = mbedtls2_psa_external_get_random(
  ...
  while (output_size > 0) {
    size_t request_size = (output_size > MBEDTLS2_PSA_RANDOM_MAX_REQUEST
                               ? MBEDTLS2_PSA_RANDOM_MAX_REQUEST
                               : output_size);
    int ret = mbedtls2_psa_get_random(MBEDTLS2_PSA_RANDOM_STATE,
                                             output, request_size);
    if (ret != 0)
      return (mbedtls2_to_psa_error(ret));
 ...
 *
 * `mbedtls2_psa_get_random(MBEDTLS2_PSA_RANDOM_STATE, ...)` calls
 * `psa_generate_random(...)`. The state parameter is ignored since the
 * PSA API doesn't support passing an explicit state.
 *
 * In the non-external case, psa_generate_random() calls an
 * `mbedtls2_xxx_drbg_random` function which has exactly the same
 * signature and semantics as mbedtls2_psa_get_random(). As an
 * optimization, instead of doing this back-and-forth between the PSA API and
 * the classic API, psa_crypto_random_impl.h defines
 * `mbedtls2_psa_get_random` as a constant function pointer to
 * `mbedtls2_xxx_drbg_random`.
 */
#if defined(MBEDTLS2_PSA_CRYPTO_EXTERNAL_RNG)
...
psa_status_t mbedtls2_psa_inject_entropy(const uint8_t *seed,
                                                size_t seed_size) {
  if (global_data.initialized)
    return (PSA_ERROR_NOT_PERMITTED);

  if (((seed_size < MBEDTLS2_ENTROPY_MIN_PLATFORM) ||
       (seed_size < MBEDTLS2_ENTROPY_BLOCK_SIZE)) ||
      (seed_size > MBEDTLS2_ENTROPY_MAX_SEED_SIZE))
    return (PSA_ERROR_INVALID_ARGUMENT);

  return (mbedtls2_psa_storage_inject_entropy(seed, seed_size));
}
...
psa_status_t psa_generate_key_internal(const psa_key_attributes_t *attributes,
  ...
  if (key_type_is_raw_bytes(type)) {
    ...
    return (mbedtls2_psa_rsa_generate_key(
...
#if defined(MBEDTLS2_PSA_BUILTIN_KEY_TYPE_ECC_KEY_PAIR)
      if (PSA_KEY_TYPE_IS_ECC(type) && PSA_KEY_TYPE_IS_KEY_PAIR(type)) {
    return (mbedtls2_psa_ecp_generate_key(
        attributes, key_buffer, key_buffer_size, key_buffer_length));
  } else
#endif /* defined(MBEDTLS2_PSA_BUILTIN_KEY_TYPE_ECC_KEY_PAIR) */
  {
...
psa_status_t psa_generate_key(const psa_key_attributes_t *attributes,
  ...
  *key = MBEDTLS2_SVC_KEY_ID_INIT;
  ...
  status = psa_start_key_creation(PSA_KEY_CREATION_GENERATE, attributes, &slot,
                                  &driver);
  if (status != PSA_SUCCESS)
    goto exit;
...
#if !defined(MBEDTLS2_PSA_CRYPTO_EXTERNAL_RNG)
psa_status_t mbedtls2_psa_crypto_configure_entropy_sources(
...
#endif /* !defined(MBEDTLS2_PSA_CRYPTO_EXTERNAL_RNG) */

void mbedtls2_psa_crypto_free(void) {
  psa_wipe_all_key_slots();
  if (global_data.rng_state != RNG_NOT_INITIALIZED) {
    mbedtls2_psa_random_free(&global_data.rng);
  }
  /* Wipe all remaining data, including configuration.
   * In particular, this sets all state indicator to the value
   * indicating "uninitialized". */
  mbedtls2_platform_zeroize(&global_data, sizeof(global_data));
...
psa_status_t psa_crypto_init(void) {
  ...
  mbedtls2_psa_random_init(&global_data.rng);
  global_data.rng_state = RNG_INITIALIZED;
  status = mbedtls2_psa_random_seed(&global_data.rng);
  if (status != PSA_SUCCESS)
    goto exit;
