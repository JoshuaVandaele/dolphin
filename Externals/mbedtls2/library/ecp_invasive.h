 ...
 */
#ifndef MBEDTLS2_ECP_INVASIVE_H
#define MBEDTLS2_ECP_INVASIVE_H

#include "common.h"
#include "mbedtls2/bignum.h"
#include "mbedtls2/ecp.h"

#if defined(MBEDTLS2_TEST_HOOKS) && defined(MBEDTLS2_ECP_C)
 ...
 * \return          \c MBEDTLS2_ERR_ECP_xxx or
 * MBEDTLS2_ERR_MPI_xxx on failure.
 */
int mbedtls2_ecp_gen_privkey_mx(size_t n_bits, mbedtls2_mpi *d,
...
#endif /* MBEDTLS2_TEST_HOOKS && MBEDTLS2_ECP_C */

#endif /* MBEDTLS2_ECP_INVASIVE_H */
