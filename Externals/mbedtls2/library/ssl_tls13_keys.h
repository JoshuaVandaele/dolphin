 ...
 */
#if !defined(MBEDTLS2_SSL_TLS1_3_KEYS_H)
#define MBEDTLS2_SSL_TLS1_3_KEYS_H

/* This requires MBEDTLS2_SSL_TLS1_3_LABEL( idx, name, string ) to be defined at
 * the point of use. See e.g. the definition of mbedtls2_ssl_tls1_3_labels_union
 * below. */
#define MBEDTLS2_SSL_TLS1_3_LABEL_LIST                               \
    MBEDTLS2_SSL_TLS1_3_LABEL( finished    , "finished"     ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( resumption  , "resumption"   ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( traffic_upd , "traffic upd"  ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( exporter    , "exporter"     ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( key         , "key"          ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( iv          , "iv"           ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( c_hs_traffic, "c hs traffic" ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( c_ap_traffic, "c ap traffic" ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( c_e_traffic , "c e traffic"  ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( s_hs_traffic, "s hs traffic" ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( s_ap_traffic, "s ap traffic" ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( s_e_traffic , "s e traffic"  ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( e_exp_master, "e exp master" ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( res_master  , "res master"   ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( exp_master  , "exp master"   ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( ext_binder  , "ext binder"   ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( res_binder  , "res binder"   ) \
    MBEDTLS2_SSL_TLS1_3_LABEL( derived     , "derived"      )

#define MBEDTLS2_SSL_TLS1_3_LABEL( name, string )       \
    const unsigned char name    [ sizeof(string) - 1 ];

union mbedtls2_ssl_tls1_3_labels_union
{
    MBEDTLS2_SSL_TLS1_3_LABEL_LIST
};
struct mbedtls2_ssl_tls1_3_labels_struct
{
    MBEDTLS2_SSL_TLS1_3_LABEL_LIST
};
#undef MBEDTLS2_SSL_TLS1_3_LABEL

extern const struct mbedtls2_ssl_tls1_3_labels_struct mbedtls2_ssl_tls1_3_labels;

#define MBEDTLS2_SSL_TLS1_3_LBL_WITH_LEN( LABEL )  \
    mbedtls2_ssl_tls1_3_labels.LABEL,              \
    sizeof(mbedtls2_ssl_tls1_3_labels.LABEL)

#define MBEDTLS2_SSL_TLS1_3_KEY_SCHEDULE_MAX_LABEL_LEN  \
    sizeof( union mbedtls2_ssl_tls1_3_labels_union )
...
#define MBEDTLS2_SSL_TLS1_3_KEY_SCHEDULE_MAX_CONTEXT_LEN  \
    MBEDTLS2_MD_MAX_SIZE
...
#define MBEDTLS2_SSL_TLS1_3_KEY_SCHEDULE_MAX_EXPANSION_LEN 255
...
int mbedtls2_ssl_tls1_3_make_traffic_keys(
                     ...
                     mbedtls2_ssl_key_set *keys );


#define MBEDTLS2_SSL_TLS1_3_CONTEXT_UNHASHED 0
#define MBEDTLS2_SSL_TLS1_3_CONTEXT_HASHED   1
 ...
 *                   (value MBEDTLS2_SSL_TLS1_3_CONTEXT_HASHED), or whether
 *                   it is the content of \c Messages itself, in which case
 *                   the function takes care of the hashing
 *                   (value MBEDTLS2_SSL_TLS1_3_CONTEXT_UNHASHED).
 ...
 * see e.g. mbedtls2_ssl_tls1_3_make_traffic_keys().
 *
...
int mbedtls2_ssl_tls1_3_evolve_secret(
                   mbedtls2_md_type_t hash_alg,
                   const unsigned char *secret_old,
                   const unsigned char *input, size_t input_len,
                   unsigned char *secret_new );

#endif /* MBEDTLS2_SSL_TLS1_3_KEYS_H */
