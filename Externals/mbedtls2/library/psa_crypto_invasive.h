 ...
 * or after a call to mbedtls2_psa_crypto_free() and before any
 ...
 *                      By default this is mbedtls2_entropy_init().
 *                      This function cannot report failures directly.
 *                      To indicate a failure, set the entropy context
 *                      to a state where mbedtls2_entropy_func() will
 *                      return an error.
 * \param entropy_free  Function to free the entropy context
 *                      and associated resources.
 *                      It is called by mbedtls2_psa_crypto_free().
 *                      By default this is mbedtls2_entropy_free().
 *
 * \retval #PSA_SUCCESS
 *         Success.
...
#if defined(MBEDTLS2_TEST_HOOKS) && defined(MBEDTLS2_PSA_CRYPTO_C)
psa_status_t psa_mac_key_can_do(psa_algorithm_t algorithm,
                                psa_key_type_t key_type);
#endif /* MBEDTLS2_TEST_HOOKS && MBEDTLS2_PSA_CRYPTO_C */
