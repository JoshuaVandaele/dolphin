 ...
 * - Only key ids from 1 to #MBEDTLS2_PSA_KEY_SLOT_COUNT are actually used.
 *
 ...
 * \retval #PSA_ERROR_DATA_INVALID
 */
psa_status_t psa_destroy_persistent_key( const mbedtls2_svc_key_id_t key );
...
/** Backend side of mbedtls2_psa_inject_entropy().
 *
 ...
 */
psa_status_t mbedtls2_psa_storage_inject_entropy( const unsigned char *seed,
                                                 size_t seed_size );
