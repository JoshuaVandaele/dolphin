...
#ifndef MBEDTLS2_MPS_ERROR_H
#define MBEDTLS2_MPS_ERROR_H


/* TODO: The error code allocation needs to be revisited:
 *
 * - Should we make (some of) the MPS Reader error codes public?
 *   If so, we need to adjust MBEDTLS2_MPS_READER_MAKE_ERROR() to hit
...
#ifndef MBEDTLS2_MPS_ERR_BASE
#define MBEDTLS2_MPS_ERR_BASE ( 0 )
#endif

#define MBEDTLS2_MPS_MAKE_ERROR(code) \
    ( -( MBEDTLS2_MPS_ERR_BASE | (code) ) )

#define MBEDTLS2_ERR_MPS_OPERATION_UNEXPECTED  MBEDTLS2_MPS_MAKE_ERROR( 0x1 )
#define MBEDTLS2_ERR_MPS_INTERNAL_ERROR        MBEDTLS2_MPS_MAKE_ERROR( 0x2 )
...
#ifndef MBEDTLS2_MPS_READER_ERR_BASE
#define MBEDTLS2_MPS_READER_ERR_BASE ( 1 << 8 )
#endif

#define MBEDTLS2_MPS_READER_MAKE_ERROR(code) \
    ( -( MBEDTLS2_MPS_READER_ERR_BASE | (code) ) )

/*! An attempt to reclaim the data buffer from a reader failed because
 *  the user hasn't yet read and committed all of it. */
#define MBEDTLS2_ERR_MPS_READER_DATA_LEFT             MBEDTLS2_MPS_READER_MAKE_ERROR( 0x1 )

/*! An invalid argument was passed to the reader. */
#define MBEDTLS2_ERR_MPS_READER_INVALID_ARG           MBEDTLS2_MPS_READER_MAKE_ERROR( 0x2 )

/*! An attempt to move a reader to consuming mode through mbedtls2_mps_reader_feed()
 *  after pausing failed because the provided data is not sufficient to serve the
 *  read requests that led to the pausing. */
#define MBEDTLS2_ERR_MPS_READER_NEED_MORE             MBEDTLS2_MPS_READER_MAKE_ERROR( 0x3 )

/*! A get request failed because not enough data is available in the reader. */
#define MBEDTLS2_ERR_MPS_READER_OUT_OF_DATA           MBEDTLS2_MPS_READER_MAKE_ERROR( 0x4 )
...
#define MBEDTLS2_ERR_MPS_READER_INCONSISTENT_REQUESTS MBEDTLS2_MPS_READER_MAKE_ERROR( 0x5 )
...
#define MBEDTLS2_ERR_MPS_READER_NEED_ACCUMULATOR      MBEDTLS2_MPS_READER_MAKE_ERROR( 0x6 )
...
#define MBEDTLS2_ERR_MPS_READER_ACCUMULATOR_TOO_SMALL MBEDTLS2_MPS_READER_MAKE_ERROR( 0x7 )

/* \} name SECTION: MPS Reader error codes */

#endif /* MBEDTLS2_MPS_ERROR_H */
