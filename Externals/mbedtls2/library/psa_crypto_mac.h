 ...
 *       drivers.
 *
 * The PSA core calls mbedtls2_psa_mac_sign_setup() or
 * mbedtls2_psa_mac_verify_setup() before calling this function.
 *
 * If this function returns an error status, the PSA core aborts the
 * operation by calling mbedtls2_psa_mac_abort().
 *
 ...
 * \retval #PSA_ERROR_CORRUPTION_DETECTED
 */
psa_status_t mbedtls2_psa_mac_update(
    mbedtls2_psa_mac_operation_t *operation,
    const uint8_t *input,
    size_t input_length );
 ...
 *       drivers.
 *
 * The PSA core calls mbedtls2_psa_mac_sign_setup() before calling this function.
 * This function calculates the MAC of the message formed by concatenating
 * the inputs passed to preceding calls to mbedtls2_psa_mac_update().
 *
 * Whether this function returns successfully or not, the PSA core subsequently
 * aborts the operation by calling mbedtls2_psa_mac_abort().
 *
 * \param[in,out] operation Active MAC operation.
 * \param[out] mac          Buffer where the MAC value is to be written.
 ...
 *                          mbedtls2_psa_mac_sign_setup(). It also guarantees the
 ...
 *
 * The PSA core calls mbedtls2_psa_mac_verify_setup() before calling this
 * function. This function calculates the MAC of the message formed by
 * concatenating the inputs passed to preceding calls to
 * mbedtls2_psa_mac_update(). It then compares the calculated MAC with the
 ...
 *                          to mbedtls2_psa_mac_verify_setup().
 *
 * \retval #PSA_SUCCESS
 ...
 * mbedtls2_psa_mac_sign_setup() or mbedtls2_psa_mac_verify_setup() again.
 *
 ...
 * #mbedtls2_psa_mac_operation_t.
 *
 * In particular, calling mbedtls2_psa_mac_abort() after the operation has been
 * terminated by a call to mbedtls2_psa_mac_abort(),
 * mbedtls2_psa_mac_sign_finish() or mbedtls2_psa_mac_verify_finish() is safe and
 * has no effect.
 *
 ...
 * \retval #PSA_ERROR_CORRUPTION_DETECTED
 */
psa_status_t mbedtls2_psa_mac_abort(
    mbedtls2_psa_mac_operation_t *operation );
