...
const char mbedtls2_test_ca_crt_ec_pem[] = TEST_CA_CRT_EC_PEM;
const char mbedtls2_test_ca_key_ec_pem[] = TEST_CA_KEY_EC_PEM;
const char mbedtls2_test_ca_pwd_ec_pem[] = TEST_CA_PWD_EC_PEM;
const char mbedtls2_test_ca_key_rsa_pem[] = TEST_CA_KEY_RSA_PEM;
const char mbedtls2_test_ca_pwd_rsa_pem[] = TEST_CA_PWD_RSA_PEM;
const char mbedtls2_test_ca_crt_rsa_sha1_pem[] =
    TEST_CA_CRT_RSA_SHA1_PEM;
const char mbedtls2_test_ca_crt_rsa_sha256_pem[] =
    TEST_CA_CRT_RSA_SHA256_PEM;

const unsigned char mbedtls2_test_ca_crt_ec_der[] = TEST_CA_CRT_EC_DER;
const unsigned char mbedtls2_test_ca_key_ec_der[] = TEST_CA_KEY_EC_DER;
const unsigned char mbedtls2_test_ca_key_rsa_der[] = TEST_CA_KEY_RSA_DER;
const unsigned char mbedtls2_test_ca_crt_rsa_sha1_der[] =
    TEST_CA_CRT_RSA_SHA1_DER;
const unsigned char mbedtls2_test_ca_crt_rsa_sha256_der[] =
    TEST_CA_CRT_RSA_SHA256_DER;

const size_t mbedtls2_test_ca_crt_ec_pem_len =
    sizeof(mbedtls2_test_ca_crt_ec_pem);
const size_t mbedtls2_test_ca_key_ec_pem_len =
    sizeof(mbedtls2_test_ca_key_ec_pem);
const size_t mbedtls2_test_ca_pwd_ec_pem_len =
    sizeof(mbedtls2_test_ca_pwd_ec_pem) - 1;
const size_t mbedtls2_test_ca_key_rsa_pem_len =
    sizeof(mbedtls2_test_ca_key_rsa_pem);
const size_t mbedtls2_test_ca_pwd_rsa_pem_len =
    sizeof(mbedtls2_test_ca_pwd_rsa_pem) - 1;
const size_t mbedtls2_test_ca_crt_rsa_sha1_pem_len =
    sizeof(mbedtls2_test_ca_crt_rsa_sha1_pem);
const size_t mbedtls2_test_ca_crt_rsa_sha256_pem_len =
    sizeof(mbedtls2_test_ca_crt_rsa_sha256_pem);

const size_t mbedtls2_test_ca_crt_ec_der_len =
    sizeof(mbedtls2_test_ca_crt_ec_der);
const size_t mbedtls2_test_ca_key_ec_der_len =
    sizeof(mbedtls2_test_ca_key_ec_der);
const size_t mbedtls2_test_ca_pwd_ec_der_len = 0;
const size_t mbedtls2_test_ca_key_rsa_der_len =
    sizeof(mbedtls2_test_ca_key_rsa_der);
const size_t mbedtls2_test_ca_pwd_rsa_der_len = 0;
const size_t mbedtls2_test_ca_crt_rsa_sha1_der_len =
    sizeof(mbedtls2_test_ca_crt_rsa_sha1_der);
const size_t mbedtls2_test_ca_crt_rsa_sha256_der_len =
    sizeof(mbedtls2_test_ca_crt_rsa_sha256_der);

/*
 * Server
 */

const char mbedtls2_test_srv_crt_ec_pem[] = TEST_SRV_CRT_EC_PEM;
const char mbedtls2_test_srv_key_ec_pem[] = TEST_SRV_KEY_EC_PEM;
const char mbedtls2_test_srv_pwd_ec_pem[] = "";
const char mbedtls2_test_srv_key_rsa_pem[] = TEST_SRV_KEY_RSA_PEM;
const char mbedtls2_test_srv_pwd_rsa_pem[] = "";
const char mbedtls2_test_srv_crt_rsa_sha1_pem[] =
    TEST_SRV_CRT_RSA_SHA1_PEM;
const char mbedtls2_test_srv_crt_rsa_sha256_pem[] =
    TEST_SRV_CRT_RSA_SHA256_PEM;

const unsigned char mbedtls2_test_srv_crt_ec_der[] = TEST_SRV_CRT_EC_DER;
const unsigned char mbedtls2_test_srv_key_ec_der[] = TEST_SRV_KEY_EC_DER;
const unsigned char mbedtls2_test_srv_key_rsa_der[] =
    TEST_SRV_KEY_RSA_DER;
const unsigned char mbedtls2_test_srv_crt_rsa_sha1_der[] =
    TEST_SRV_CRT_RSA_SHA1_DER;
const unsigned char mbedtls2_test_srv_crt_rsa_sha256_der[] =
    TEST_SRV_CRT_RSA_SHA256_DER;

const size_t mbedtls2_test_srv_crt_ec_pem_len =
    sizeof(mbedtls2_test_srv_crt_ec_pem);
const size_t mbedtls2_test_srv_key_ec_pem_len =
    sizeof(mbedtls2_test_srv_key_ec_pem);
const size_t mbedtls2_test_srv_pwd_ec_pem_len =
    sizeof(mbedtls2_test_srv_pwd_ec_pem) - 1;
const size_t mbedtls2_test_srv_key_rsa_pem_len =
    sizeof(mbedtls2_test_srv_key_rsa_pem);
const size_t mbedtls2_test_srv_pwd_rsa_pem_len =
    sizeof(mbedtls2_test_srv_pwd_rsa_pem) - 1;
const size_t mbedtls2_test_srv_crt_rsa_sha1_pem_len =
    sizeof(mbedtls2_test_srv_crt_rsa_sha1_pem);
const size_t mbedtls2_test_srv_crt_rsa_sha256_pem_len =
    sizeof(mbedtls2_test_srv_crt_rsa_sha256_pem);

const size_t mbedtls2_test_srv_crt_ec_der_len =
    sizeof(mbedtls2_test_srv_crt_ec_der);
const size_t mbedtls2_test_srv_key_ec_der_len =
    sizeof(mbedtls2_test_srv_key_ec_der);
const size_t mbedtls2_test_srv_pwd_ec_der_len = 0;
const size_t mbedtls2_test_srv_key_rsa_der_len =
    sizeof(mbedtls2_test_srv_key_rsa_der);
const size_t mbedtls2_test_srv_pwd_rsa_der_len = 0;
const size_t mbedtls2_test_srv_crt_rsa_sha1_der_len =
    sizeof(mbedtls2_test_srv_crt_rsa_sha1_der);
const size_t mbedtls2_test_srv_crt_rsa_sha256_der_len =
    sizeof(mbedtls2_test_srv_crt_rsa_sha256_der);

/*
 * Client
 */

const char mbedtls2_test_cli_crt_ec_pem[] = TEST_CLI_CRT_EC_PEM;
const char mbedtls2_test_cli_key_ec_pem[] = TEST_CLI_KEY_EC_PEM;
const char mbedtls2_test_cli_pwd_ec_pem[] = "";
const char mbedtls2_test_cli_key_rsa_pem[] = TEST_CLI_KEY_RSA_PEM;
const char mbedtls2_test_cli_pwd_rsa_pem[] = "";
const char mbedtls2_test_cli_crt_rsa_pem[] = TEST_CLI_CRT_RSA_PEM;

const unsigned char mbedtls2_test_cli_crt_ec_der[] = TEST_CLI_CRT_EC_DER;
const unsigned char mbedtls2_test_cli_key_ec_der[] = TEST_CLI_KEY_EC_DER;
const unsigned char mbedtls2_test_cli_key_rsa_der[] =
    TEST_CLI_KEY_RSA_DER;
const unsigned char mbedtls2_test_cli_crt_rsa_der[] =
    TEST_CLI_CRT_RSA_DER;

const size_t mbedtls2_test_cli_crt_ec_pem_len =
    sizeof(mbedtls2_test_cli_crt_ec_pem);
const size_t mbedtls2_test_cli_key_ec_pem_len =
    sizeof(mbedtls2_test_cli_key_ec_pem);
const size_t mbedtls2_test_cli_pwd_ec_pem_len =
    sizeof(mbedtls2_test_cli_pwd_ec_pem) - 1;
const size_t mbedtls2_test_cli_key_rsa_pem_len =
    sizeof(mbedtls2_test_cli_key_rsa_pem);
const size_t mbedtls2_test_cli_pwd_rsa_pem_len =
    sizeof(mbedtls2_test_cli_pwd_rsa_pem) - 1;
const size_t mbedtls2_test_cli_crt_rsa_pem_len =
    sizeof(mbedtls2_test_cli_crt_rsa_pem);

const size_t mbedtls2_test_cli_crt_ec_der_len =
    sizeof(mbedtls2_test_cli_crt_ec_der);
const size_t mbedtls2_test_cli_key_ec_der_len =
    sizeof(mbedtls2_test_cli_key_ec_der);
const size_t mbedtls2_test_cli_key_rsa_der_len =
    sizeof(mbedtls2_test_cli_key_rsa_der);
const size_t mbedtls2_test_cli_crt_rsa_der_len =
    sizeof(mbedtls2_test_cli_crt_rsa_der);

/*
 *
 * Definitions of test CRTs without specification of all parameters, choosing
 * them automatically according to the config. For example,
 * mbedtls2_test_ca_crt is one of
 * mbedtls2_test_ca_crt_{rsa|ec}_{sha1|sha256}_{pem|der}.
 *
 */
...
const char mbedtls2_test_ca_key_rsa[] = TEST_CA_KEY_RSA;
const char mbedtls2_test_ca_pwd_rsa[] = TEST_CA_PWD_RSA;
const char mbedtls2_test_ca_crt_rsa_sha256[] = TEST_CA_CRT_RSA_SHA256;
const char mbedtls2_test_ca_crt_rsa_sha1[] = TEST_CA_CRT_RSA_SHA1;
const char mbedtls2_test_ca_key_ec[] = TEST_CA_KEY_EC;
const char mbedtls2_test_ca_pwd_ec[] = TEST_CA_PWD_EC;
const char mbedtls2_test_ca_crt_ec[] = TEST_CA_CRT_EC;

const char mbedtls2_test_srv_key_rsa[] = TEST_SRV_KEY_RSA;
const char mbedtls2_test_srv_pwd_rsa[] = TEST_SRV_PWD_RSA;
const char mbedtls2_test_srv_crt_rsa_sha256[] = TEST_SRV_CRT_RSA_SHA256;
const char mbedtls2_test_srv_crt_rsa_sha1[] = TEST_SRV_CRT_RSA_SHA1;
const char mbedtls2_test_srv_key_ec[] = TEST_SRV_KEY_EC;
const char mbedtls2_test_srv_pwd_ec[] = TEST_SRV_PWD_EC;
const char mbedtls2_test_srv_crt_ec[] = TEST_SRV_CRT_EC;

const char mbedtls2_test_cli_key_rsa[] = TEST_CLI_KEY_RSA;
const char mbedtls2_test_cli_pwd_rsa[] = TEST_CLI_PWD_RSA;
const char mbedtls2_test_cli_crt_rsa[] = TEST_CLI_CRT_RSA;
const char mbedtls2_test_cli_key_ec[] = TEST_CLI_KEY_EC;
const char mbedtls2_test_cli_pwd_ec[] = TEST_CLI_PWD_EC;
const char mbedtls2_test_cli_crt_ec[] = TEST_CLI_CRT_EC;

const size_t mbedtls2_test_ca_key_rsa_len =
    sizeof(mbedtls2_test_ca_key_rsa);
const size_t mbedtls2_test_ca_pwd_rsa_len =
    sizeof(mbedtls2_test_ca_pwd_rsa) - 1;
const size_t mbedtls2_test_ca_crt_rsa_sha256_len =
    sizeof(mbedtls2_test_ca_crt_rsa_sha256);
const size_t mbedtls2_test_ca_crt_rsa_sha1_len =
    sizeof(mbedtls2_test_ca_crt_rsa_sha1);
const size_t mbedtls2_test_ca_key_ec_len =
    sizeof(mbedtls2_test_ca_key_ec);
const size_t mbedtls2_test_ca_pwd_ec_len =
    sizeof(mbedtls2_test_ca_pwd_ec) - 1;
const size_t mbedtls2_test_ca_crt_ec_len =
    sizeof(mbedtls2_test_ca_crt_ec);

const size_t mbedtls2_test_srv_key_rsa_len =
    sizeof(mbedtls2_test_srv_key_rsa);
const size_t mbedtls2_test_srv_pwd_rsa_len =
    sizeof(mbedtls2_test_srv_pwd_rsa) - 1;
const size_t mbedtls2_test_srv_crt_rsa_sha256_len =
    sizeof(mbedtls2_test_srv_crt_rsa_sha256);
const size_t mbedtls2_test_srv_crt_rsa_sha1_len =
    sizeof(mbedtls2_test_srv_crt_rsa_sha1);
const size_t mbedtls2_test_srv_key_ec_len =
    sizeof(mbedtls2_test_srv_key_ec);
const size_t mbedtls2_test_srv_pwd_ec_len =
    sizeof(mbedtls2_test_srv_pwd_ec) - 1;
const size_t mbedtls2_test_srv_crt_ec_len =
    sizeof(mbedtls2_test_srv_crt_ec);

const size_t mbedtls2_test_cli_key_rsa_len =
    sizeof(mbedtls2_test_cli_key_rsa);
const size_t mbedtls2_test_cli_pwd_rsa_len =
    sizeof(mbedtls2_test_cli_pwd_rsa) - 1;
const size_t mbedtls2_test_cli_crt_rsa_len =
    sizeof(mbedtls2_test_cli_crt_rsa);
const size_t mbedtls2_test_cli_key_ec_len =
    sizeof(mbedtls2_test_cli_key_ec);
const size_t mbedtls2_test_cli_pwd_ec_len =
    sizeof(mbedtls2_test_cli_pwd_ec) - 1;
const size_t mbedtls2_test_cli_crt_ec_len =
    sizeof(mbedtls2_test_cli_crt_ec);
...
const char mbedtls2_test_ca_crt_rsa[] = TEST_CA_CRT_RSA;
const char mbedtls2_test_srv_crt_rsa[] = TEST_SRV_CRT_RSA;

const size_t mbedtls2_test_ca_crt_rsa_len =
    sizeof(mbedtls2_test_ca_crt_rsa);
const size_t mbedtls2_test_srv_crt_rsa_len =
    sizeof(mbedtls2_test_srv_crt_rsa);
 ...
 *   mbedtls2_test_{ca|srv|cli}_{key|pwd|crt}
 * as pointers. */
...
const char *mbedtls2_test_ca_key = test_ca_key;
const char *mbedtls2_test_ca_pwd = test_ca_pwd;
const char *mbedtls2_test_ca_crt = test_ca_crt;

const char *mbedtls2_test_srv_key = test_srv_key;
const char *mbedtls2_test_srv_pwd = test_srv_pwd;
const char *mbedtls2_test_srv_crt = test_srv_crt;

const char *mbedtls2_test_cli_key = test_cli_key;
const char *mbedtls2_test_cli_pwd = test_cli_pwd;
const char *mbedtls2_test_cli_crt = test_cli_crt;

const size_t mbedtls2_test_ca_key_len = sizeof(test_ca_key);
const size_t mbedtls2_test_ca_pwd_len = sizeof(test_ca_pwd) - 1;
const size_t mbedtls2_test_ca_crt_len = sizeof(test_ca_crt);

const size_t mbedtls2_test_srv_key_len = sizeof(test_srv_key);
const size_t mbedtls2_test_srv_pwd_len = sizeof(test_srv_pwd) - 1;
const size_t mbedtls2_test_srv_crt_len = sizeof(test_srv_crt);

const size_t mbedtls2_test_cli_key_len = sizeof(test_cli_key);
const size_t mbedtls2_test_cli_pwd_len = sizeof(test_cli_pwd) - 1;
const size_t mbedtls2_test_cli_crt_len = sizeof(test_cli_crt);
...
const char *mbedtls2_test_cas[] = {
#if defined(MBEDTLS2_RSA_C) && defined(MBEDTLS2_SHA1_C)
    mbedtls2_test_ca_crt_rsa_sha1,
#endif
#if defined(MBEDTLS2_RSA_C) && defined(MBEDTLS2_SHA256_C)
    mbedtls2_test_ca_crt_rsa_sha256,
#endif
#if defined(MBEDTLS2_ECDSA_C)
    mbedtls2_test_ca_crt_ec,
#endif
    NULL};
const size_t mbedtls2_test_cas_len[] = {
#if defined(MBEDTLS2_RSA_C) && defined(MBEDTLS2_SHA1_C)
    sizeof(mbedtls2_test_ca_crt_rsa_sha1),
#endif
#if defined(MBEDTLS2_RSA_C) && defined(MBEDTLS2_SHA256_C)
...
const unsigned char *mbedtls2_test_cas_der[] = {
#if defined(MBEDTLS2_RSA_C)
#if defined(MBEDTLS2_SHA256_C)
    mbedtls2_test_ca_crt_rsa_sha256_der,
#endif /* MBEDTLS2_SHA256_C */
#if defined(MBEDTLS2_SHA1_C)
    mbedtls2_test_ca_crt_rsa_sha1_der,
#endif /* MBEDTLS2_SHA1_C */
#endif /* MBEDTLS2_RSA_C */
#if defined(MBEDTLS2_ECDSA_C)
    mbedtls2_test_ca_crt_ec_der,
#endif /* MBEDTLS2_ECDSA_C */
    NULL};

const size_t mbedtls2_test_cas_der_len[] = {
#if defined(MBEDTLS2_RSA_C)
#if defined(MBEDTLS2_SHA256_C)
    sizeof(mbedtls2_test_ca_crt_rsa_sha256_der),
#endif /* MBEDTLS2_SHA256_C */
...
#if defined(MBEDTLS2_PEM_PARSE_C)
const char mbedtls2_test_cas_pem[] =
#if defined(MBEDTLS2_RSA_C)
#if defined(MBEDTLS2_SHA256_C)
    TEST_CA_CRT_RSA_SHA256_PEM
#endif /* MBEDTLS2_SHA256_C */
...
#endif /* MBEDTLS2_ECDSA_C */
    "";
const size_t mbedtls2_test_cas_pem_len =
    sizeof(mbedtls2_test_cas_pem);
#endif /* MBEDTLS2_PEM_PARSE_C */
