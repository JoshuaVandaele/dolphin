...
#define MBEDTLS2_PSA_KA_FLAG_HAS_SLOT_NUMBER                            \
  ((psa_key_attributes_flag_t)0x0001)

/* A mask of key attribute flags used externally only.
 * Only meant for internal checks inside the library. */
#define MBEDTLS2_PSA_KA_MASK_EXTERNAL_ONLY                              \
  (MBEDTLS2_PSA_KA_FLAG_HAS_SLOT_NUMBER | 0)

/* A mask of key attribute flags used both internally and externally.
 * Currently there aren't any. */
#define MBEDTLS2_PSA_KA_MASK_DUAL_USE (0)

typedef struct {
  psa_key_type_t type;
  psa_key_bits_t bits;
  psa_key_lifetime_t lifetime;
  mbedtls2_svc_key_id_t id;
...
#define PSA_CORE_KEY_ATTRIBUTES_INIT                                           \
  {PSA_KEY_TYPE_NONE,         0,                                               \
   PSA_KEY_LIFETIME_VOLATILE, MBEDTLS2_SVC_KEY_ID_INIT,                 \
...
static inline mbedtls2_svc_key_id_t
...
static inline void
mbedtls2_set_key_owner_id(psa_key_attributes_t *attributes,
