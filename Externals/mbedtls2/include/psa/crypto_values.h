...
#define MBEDTLS2_SVC_KEY_ID_INIT ( (psa_key_id_t)0 )
#define MBEDTLS2_SVC_KEY_ID_GET_KEY_ID( id ) ( id )
#define MBEDTLS2_SVC_KEY_ID_GET_OWNER_ID( id ) ( 0 )
 ...
 */
static inline mbedtls2_svc_key_id_t mbedtls2_svc_key_id_make(
 ...
 */
static inline int mbedtls2_svc_key_id_equal( mbedtls2_svc_key_id_t id1,
                                            mbedtls2_svc_key_id_t id2 )
{
    return( id1 == id2 );
}
 ...
 */
static inline int mbedtls2_svc_key_id_is_null( mbedtls2_svc_key_id_t key )
{
    return( key == 0 );
}

#else /* MBEDTLS2_PSA_CRYPTO_KEY_ID_ENCODES_OWNER */

#define MBEDTLS2_SVC_KEY_ID_INIT ( (mbedtls2_svc_key_id_t){ 0, 0 } )
#define MBEDTLS2_SVC_KEY_ID_GET_KEY_ID( id ) ( ( id ).key_id )
#define MBEDTLS2_SVC_KEY_ID_GET_OWNER_ID( id ) ( ( id ).owner )
 ...
 */
static inline mbedtls2_svc_key_id_t mbedtls2_svc_key_id_make(
    mbedtls2_key_owner_id_t owner_id, psa_key_id_t key_id )
{
    return( (mbedtls2_svc_key_id_t){ .key_id = key_id,
                                    .owner = owner_id } );
}
                                            ...
                                            mbedtls2_svc_key_id_t id2 )
{
    return( ( id1.key_id == id2.key_id ) &&
            mbedtls2_key_owner_id_equal( id1.owner, id2.owner ) );
}
 ...
 */
#define MBEDTLS2_PSA_ALG_AEAD_EQUAL(aead_alg_1, aead_alg_2) \
