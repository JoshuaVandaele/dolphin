...
#if defined(__DOXYGEN_ONLY__) || !defined(MBEDTLS2_PSA_CRYPTO_SE_C)
...
#endif /* __DOXYGEN_ONLY__ || !MBEDTLS2_PSA_CRYPTO_SE_C */
...
typedef enum
{
    ...
    /** A key is being registered with mbedtls2_psa_register_se_key().
     *
