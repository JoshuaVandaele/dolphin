...
#ifdef MBEDTLS2_PSA_CRYPTO_KEY_ID_ENCODES_OWNER
 ...
 */
static void mbedtls2_set_key_owner_id( psa_key_attributes_t *attributes,
                                      mbedtls2_key_owner_id_t owner );
#endif
 ...
 *         the key as volatile.
 */
static mbedtls2_svc_key_id_t psa_get_key_id(
 ...
 *         results in this error code.
 */
psa_status_t psa_export_key(mbedtls2_svc_key_id_t key,
                            uint8_t *data,
                            size_t data_size,
                            size_t *data_length);
