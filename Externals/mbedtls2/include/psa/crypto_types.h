...
/* If MBEDTLS2_PSA_CRYPTO_C is defined, make sure MBEDTLS2_PSA_CRYPTO_CLIENT
 ...
 * a factory reset).
 *
 * Persistent keys have a key identifier of type #mbedtls2_svc_key_id_t.
...
typedef psa_key_id_t mbedtls2_svc_key_id_t;
