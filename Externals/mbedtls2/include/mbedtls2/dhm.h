...
#ifndef MBEDTLS2_DHM_H
#define MBEDTLS2_DHM_H
...
#define MBEDTLS2_ERR_DHM_BAD_INPUT_DATA -0x3080
/** Reading of the DHM parameters failed. */
#define MBEDTLS2_ERR_DHM_READ_PARAMS_FAILED -0x3100
/** Making of the DHM parameters failed. */
#define MBEDTLS2_ERR_DHM_MAKE_PARAMS_FAILED -0x3180
/** Reading of the public values failed. */
#define MBEDTLS2_ERR_DHM_READ_PUBLIC_FAILED -0x3200
/** Making of the public value failed. */
#define MBEDTLS2_ERR_DHM_MAKE_PUBLIC_FAILED -0x3280
/** Calculation of the DHM secret failed. */
#define MBEDTLS2_ERR_DHM_CALC_SECRET_FAILED -0x3300
/** The ASN.1 data is not formatted correctly. */
#define MBEDTLS2_ERR_DHM_INVALID_FORMAT -0x3380
/** Allocation of memory failed. */
#define MBEDTLS2_ERR_DHM_ALLOC_FAILED -0x3400
/** Read or write of file failed. */
#define MBEDTLS2_ERR_DHM_FILE_IO_ERROR -0x3480

/* MBEDTLS2_ERR_DHM_HW_ACCEL_FAILED is deprecated and should not be used.
 */
/** DHM hardware accelerator failed. */
#define MBEDTLS2_ERR_DHM_HW_ACCEL_FAILED -0x3500

/** Setting the modulus and generator failed. */
#define MBEDTLS2_ERR_DHM_SET_GROUP_FAILED -0x3580
 ...
 */
typedef struct mbedtls2_dhm_context {
  size_t len;             /*!<  The size of \p P in Bytes. */
  mbedtls2_mpi P;  /*!<  The prime modulus. */
  mbedtls2_mpi G;  /*!<  The generator. */
  mbedtls2_mpi X;  /*!<  Our secret value. */
  mbedtls2_mpi GX; /*!<  Our public key = \c G^X mod \c P. */
  mbedtls2_mpi GY; /*!<  The public key of the peer = \c G^Y mod \c P. */
  mbedtls2_mpi K;  /*!<  The shared secret = \c G^(XY) mod \c P. */
  mbedtls2_mpi RP; /*!<  The cached value = \c R^2 mod \c P. */
  mbedtls2_mpi Vi; /*!<  The blinding value. */
  mbedtls2_mpi Vf; /*!<  The unblinding value. */
  mbedtls2_mpi pX; /*!<  The previous \c X. */
} mbedtls2_dhm_context;

#else /* MBEDTLS2_DHM_ALT */
#include "dhm_alt.h"
 ...
 * \return         An \c MBEDTLS2_ERR_DHM_XXX error code on failure.
 */
 ...
 *                 mbedtls2_dhm_set_group() below in conjunction with
 *                 mbedtls2_mpi_read_binary() and
 * mbedtls2_mpi_read_string().
 *
 ...
 *                 mbedtls2_mpi_size() to computing the byte-size of an
 * MPI.
 ...
 *                 in preparation for mbedtls2_dhm_make_params().
 *
 ...
 *                 its DHM parameters set, e.g. via
 * mbedtls2_dhm_set_group(). It may or may not already have generated its
 * own private key.
 ...
 *
 * \return            \c 0 on success.
 * \return            An \c MBEDTLS2_ERR_DHM_XXX or \c
 * MBEDTLS2_ERR_PEM_XXX error code on failure.
 */
 ...
 * through \c mbedtls2_ssl_conf_dh_param.
 *
 ...
 * IETF Standards</em>.
 */
#define MBEDTLS2_DHM_RFC5114_MODP_2048_P                                \
  MBEDTLS2_DEPRECATED_STRING_CONSTANT(                                  \
 ...
 */
#define MBEDTLS2_DHM_RFC5114_MODP_2048_G                                \
  MBEDTLS2_DEPRECATED_STRING_CONSTANT(                                  \
 ...
 *
 */
#define MBEDTLS2_DHM_RFC3526_MODP_2048_P                                \
  MBEDTLS2_DEPRECATED_STRING_CONSTANT(                                  \
 ...
 * Diffie-Hellman groups for Internet Key Exchange (IKE)</em>.
 */
#define MBEDTLS2_DHM_RFC3526_MODP_2048_G                                \
  MBEDTLS2_DEPRECATED_STRING_CONSTANT("02")
 ...
 * Diffie-Hellman groups for Internet Key Exchange (IKE)</em>.
 */
#define MBEDTLS2_DHM_RFC3526_MODP_3072_P                                \
  MBEDTLS2_DEPRECATED_STRING_CONSTANT(                                  \
      "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1"                       \
      "29024E088A67CC74020BBEA63B139B22514A08798E3404DD"                       \
      "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245"                       \
 ...
 * Diffie-Hellman groups for Internet Key Exchange (IKE)</em>.
 */
#define MBEDTLS2_DHM_RFC3526_MODP_3072_G                                \
  MBEDTLS2_DEPRECATED_STRING_CONSTANT("02")
 ...
 * Diffie-Hellman groups for Internet Key Exchange (IKE)</em>.
 */
#define MBEDTLS2_DHM_RFC3526_MODP_4096_P                                \
  MBEDTLS2_DEPRECATED_STRING_CONSTANT(                                  \
      "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1"                       \
      "29024E088A67CC74020BBEA63B139B22514A08798E3404DD"                       \
      "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245"                       \
 ...
 * Diffie-Hellman groups for Internet Key Exchange (IKE)</em>.
 */
#define MBEDTLS2_DHM_RFC3526_MODP_4096_G                                \
  MBEDTLS2_DEPRECATED_STRING_CONSTANT("02")
...
#define MBEDTLS2_DHM_RFC3526_MODP_2048_P_BIN                            \
  {                                                                            \
...
#define MBEDTLS2_DHM_RFC3526_MODP_2048_G_BIN {0x02}

#define MBEDTLS2_DHM_RFC3526_MODP_3072_P_BIN                            \
  {                                                                            \
      0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA, 0xA2,  \
      0x21, 0x68, 0xC2, 0x34, 0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1,  \
      0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74, 0x02, 0x0B, 0xBE, 0xA6,  \
...
#define MBEDTLS2_DHM_RFC3526_MODP_3072_G_BIN {0x02}

#define MBEDTLS2_DHM_RFC3526_MODP_4096_P_BIN                            \
  {                                                                            \
      0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA, 0xA2,  \
      0x21, 0x68, 0xC2, 0x34, 0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1,  \
      0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74, 0x02, 0x0B, 0xBE, 0xA6,  \
...
#define MBEDTLS2_DHM_RFC3526_MODP_4096_G_BIN {0x02}

#define MBEDTLS2_DHM_RFC7919_FFDHE2048_P_BIN                            \
  {                                                                            \
...
#define MBEDTLS2_DHM_RFC7919_FFDHE2048_G_BIN {0x02}

#define MBEDTLS2_DHM_RFC7919_FFDHE3072_P_BIN                            \
  {                                                                            \
      0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xAD, 0xF8, 0x54, 0x58,  \
      0xA2, 0xBB, 0x4A, 0x9A, 0xAF, 0xDC, 0x56, 0x20, 0x27, 0x3D, 0x3C, 0xF1,  \
      0xD8, 0xB9, 0xC5, 0x83, 0xCE, 0x2D, 0x36, 0x95, 0xA9, 0xE1, 0x36, 0x41,  \
...
#define MBEDTLS2_DHM_RFC7919_FFDHE3072_G_BIN {0x02}

#define MBEDTLS2_DHM_RFC7919_FFDHE4096_P_BIN                            \
  {                                                                            \
      0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xAD, 0xF8, 0x54, 0x58,  \
      0xA2, 0xBB, 0x4A, 0x9A, 0xAF, 0xDC, 0x56, 0x20, 0x27, 0x3D, 0x3C, 0xF1,  \
      0xD8, 0xB9, 0xC5, 0x83, 0xCE, 0x2D, 0x36, 0x95, 0xA9, 0xE1, 0x36, 0x41,  \
...
#define MBEDTLS2_DHM_RFC7919_FFDHE4096_G_BIN {0x02}

#define MBEDTLS2_DHM_RFC7919_FFDHE6144_P_BIN                            \
  {                                                                            \
      0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xAD, 0xF8, 0x54, 0x58,  \
      0xA2, 0xBB, 0x4A, 0x9A, 0xAF, 0xDC, 0x56, 0x20, 0x27, 0x3D, 0x3C, 0xF1,  \
      0xD8, 0xB9, 0xC5, 0x83, 0xCE, 0x2D, 0x36, 0x95, 0xA9, 0xE1, 0x36, 0x41,  \
...
#define MBEDTLS2_DHM_RFC7919_FFDHE6144_G_BIN {0x02}

#define MBEDTLS2_DHM_RFC7919_FFDHE8192_P_BIN                            \
  {                                                                            \
      0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xAD, 0xF8, 0x54, 0x58,  \
      0xA2, 0xBB, 0x4A, 0x9A, 0xAF, 0xDC, 0x56, 0x20, 0x27, 0x3D, 0x3C, 0xF1,  \
      0xD8, 0xB9, 0xC5, 0x83, 0xCE, 0x2D, 0x36, 0x95, 0xA9, 0xE1, 0x36, 0x41,  \
...
#define MBEDTLS2_DHM_RFC7919_FFDHE8192_G_BIN {0x02}
