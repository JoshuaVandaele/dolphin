 ...
 */
#ifndef MBEDTLS2_TIMING_H
#define MBEDTLS2_TIMING_H
 ...
 */
typedef struct mbedtls2_timing_delay_context {
  struct mbedtls2_timing_hr_time timer;
  uint32_t int_ms;
  uint32_t fin_ms;
} mbedtls2_timing_delay_context;

#else /* MBEDTLS2_TIMING_ALT */
 ...
 *                 Must point to a valid \c mbedtls2_timing_delay_context
 * struct.
 ...
 *
 * \note           To set a single delay, either use \c
 * mbedtls2_timing_set_timer directly or use this function with int_ms ==
 * fin_ms.
 */
