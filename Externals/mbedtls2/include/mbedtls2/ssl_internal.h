 ...
 */
#ifndef MBEDTLS2_SSL_INTERNAL_H
#define MBEDTLS2_SSL_INTERNAL_H
...
#define MBEDTLS2_SSL_MIN_MAJOR_VERSION                                  \
  MBEDTLS2_SSL_MAJOR_VERSION_3

#if defined(MBEDTLS2_SSL_PROTO_SSL3)
#define MBEDTLS2_SSL_MIN_MINOR_VERSION                                  \
  MBEDTLS2_SSL_MINOR_VERSION_0
#else
#if defined(MBEDTLS2_SSL_PROTO_TLS1)
#define MBEDTLS2_SSL_MIN_MINOR_VERSION                                  \
  MBEDTLS2_SSL_MINOR_VERSION_1
#else
...
#define MBEDTLS2_SSL_MIN_MINOR_VERSION                                  \
  MBEDTLS2_SSL_MINOR_VERSION_3
#endif /* MBEDTLS2_SSL_PROTO_TLS1_2 */
#endif /* MBEDTLS2_SSL_PROTO_TLS1_1 */
#endif /* MBEDTLS2_SSL_PROTO_TLS1   */
#endif /* MBEDTLS2_SSL_PROTO_SSL3   */

#define MBEDTLS2_SSL_MIN_VALID_MINOR_VERSION                            \
  MBEDTLS2_SSL_MINOR_VERSION_1
#define MBEDTLS2_SSL_MIN_VALID_MAJOR_VERSION                            \
  MBEDTLS2_SSL_MAJOR_VERSION_3

/* Determine maximum supported version */
#define MBEDTLS2_SSL_MAX_MAJOR_VERSION                                  \
  MBEDTLS2_SSL_MAJOR_VERSION_3

#if defined(MBEDTLS2_SSL_PROTO_TLS1_2)
#define MBEDTLS2_SSL_MAX_MINOR_VERSION                                  \
  MBEDTLS2_SSL_MINOR_VERSION_3
#else
#if defined(MBEDTLS2_SSL_PROTO_TLS1_1)
#define MBEDTLS2_SSL_MAX_MINOR_VERSION                                  \
...
#define MBEDTLS2_SSL_ECP_RESTARTABLE_ENABLED
#endif

#define MBEDTLS2_SSL_INITIAL_HANDSHAKE 0
#define MBEDTLS2_SSL_RENEGOTIATION_IN_PROGRESS 1 /* In progress */
#define MBEDTLS2_SSL_RENEGOTIATION_DONE 2        /* Done or aborted */
#define MBEDTLS2_SSL_RENEGOTIATION_PENDING                              \
  3 /* Requested (server only) */
 ...
 */
#define MBEDTLS2_SSL_RETRANS_PREPARING 0
#define MBEDTLS2_SSL_RETRANS_SENDING 1
#define MBEDTLS2_SSL_RETRANS_WAITING 2
#define MBEDTLS2_SSL_RETRANS_FINISHED 3
...
#define MBEDTLS2_SSL_COMPRESSION_ADD 1024
#else
#define MBEDTLS2_SSL_COMPRESSION_ADD 0
#endif

/* This macro determines whether CBC is supported. */
#if defined(MBEDTLS2_CIPHER_MODE_CBC) &&                                \
    (defined(MBEDTLS2_AES_C) || defined(MBEDTLS2_CAMELLIA_C) ||  \
     defined(MBEDTLS2_ARIA_C) || defined(MBEDTLS2_DES_C))
#define MBEDTLS2_SSL_SOME_SUITES_USE_CBC
#endif
 ...
 * opposed to the very different CBC construct used in SSLv3) is supported. */
    ...
    (defined(MBEDTLS2_SSL_PROTO_TLS1) ||                                \
     ...
     defined(MBEDTLS2_SSL_PROTO_TLS1_2))
#define MBEDTLS2_SSL_SOME_SUITES_USE_TLS_CBC
#endif

#if defined(MBEDTLS2_ARC4_C) ||                                         \
    defined(MBEDTLS2_CIPHER_NULL_CIPHER) ||                             \
    defined(MBEDTLS2_SSL_SOME_SUITES_USE_CBC)
#define MBEDTLS2_SSL_SOME_MODES_USE_MAC
#endif

#if defined(MBEDTLS2_SSL_SOME_MODES_USE_MAC)
/* Ciphersuites using HMAC */
#if defined(MBEDTLS2_SHA512_C)
#define MBEDTLS2_SSL_MAC_ADD 48 /* SHA-384 used for HMAC */
#elif defined(MBEDTLS2_SHA256_C)
#define MBEDTLS2_SSL_MAC_ADD 32 /* SHA-256 used for HMAC */
#else
#define MBEDTLS2_SSL_MAC_ADD 20 /* SHA-1   used for HMAC */
#endif
#else /* MBEDTLS2_SSL_SOME_MODES_USE_MAC */
/* AEAD ciphersuites: GCM and CCM use a 128 bits tag */
#define MBEDTLS2_SSL_MAC_ADD 16
#endif

#if defined(MBEDTLS2_CIPHER_MODE_CBC)
#define MBEDTLS2_SSL_PADDING_ADD 256
#else
#define MBEDTLS2_SSL_PADDING_ADD 0
#endif

#if defined(MBEDTLS2_SSL_DTLS_CONNECTION_ID)
#define MBEDTLS2_SSL_MAX_CID_EXPANSION                                  \
  MBEDTLS2_SSL_CID_PADDING_GRANULARITY
#else
#define MBEDTLS2_SSL_MAX_CID_EXPANSION 0
#endif

#define MBEDTLS2_SSL_PAYLOAD_OVERHEAD                                   \
  (MBEDTLS2_SSL_COMPRESSION_ADD + MBEDTLS2_MAX_IV_LENGTH +       \
   MBEDTLS2_SSL_MAC_ADD + MBEDTLS2_SSL_PADDING_ADD +             \
   MBEDTLS2_SSL_MAX_CID_EXPANSION)

#define MBEDTLS2_SSL_IN_PAYLOAD_LEN                                     \
  (MBEDTLS2_SSL_PAYLOAD_OVERHEAD + (MBEDTLS2_SSL_IN_CONTENT_LEN))

#define MBEDTLS2_SSL_OUT_PAYLOAD_LEN                                    \
  (MBEDTLS2_SSL_PAYLOAD_OVERHEAD + (MBEDTLS2_SSL_OUT_CONTENT_LEN))

/* The maximum number of buffered handshake messages. */
#define MBEDTLS2_SSL_MAX_BUFFERED_HS 4

/* Maximum length we can advertise as our max content length for
   RFC 6066 max_fragment_length extension negotiation purposes
   (the lesser of both sizes, if they are unequal.)
 */
#define MBEDTLS2_TLS_EXT_ADV_CONTENT_LEN                                \
  ((MBEDTLS2_SSL_IN_CONTENT_LEN > MBEDTLS2_SSL_OUT_CONTENT_LEN)  \
       ? (MBEDTLS2_SSL_OUT_CONTENT_LEN)                                 \
       : (MBEDTLS2_SSL_IN_CONTENT_LEN))

/* Maximum size in bytes of list in sig-hash algorithm ext., RFC 5246 */
#define MBEDTLS2_SSL_MAX_SIG_HASH_ALG_LIST_LEN 65534

/* Maximum size in bytes of list in supported elliptic curve ext., RFC 4492 */
#define MBEDTLS2_SSL_MAX_CURVE_LIST_LEN 65535

/*
 * Check that we obey the standard's message size bounds
 */

#if MBEDTLS2_SSL_MAX_CONTENT_LEN > 16384
#error "Bad configuration - record content too large."
#endif

#if MBEDTLS2_SSL_IN_CONTENT_LEN > MBEDTLS2_SSL_MAX_CONTENT_LEN
#error                                                                         \
    "Bad configuration - incoming record content should not be larger than MBEDTLS2_SSL_MAX_CONTENT_LEN."
#endif

#if MBEDTLS2_SSL_OUT_CONTENT_LEN > MBEDTLS2_SSL_MAX_CONTENT_LEN
#error                                                                         \
    "Bad configuration - outgoing record content should not be larger than MBEDTLS2_SSL_MAX_CONTENT_LEN."
#endif

#if MBEDTLS2_SSL_IN_PAYLOAD_LEN >                                       \
    MBEDTLS2_SSL_MAX_CONTENT_LEN + 2048
#error "Bad configuration - incoming protected record payload too large."
#endif

#if MBEDTLS2_SSL_OUT_PAYLOAD_LEN >                                      \
    MBEDTLS2_SSL_MAX_CONTENT_LEN + 2048
...
#define MBEDTLS2_SSL_HEADER_LEN 13

#if !defined(MBEDTLS2_SSL_DTLS_CONNECTION_ID)
#define MBEDTLS2_SSL_IN_BUFFER_LEN                                      \
  ((MBEDTLS2_SSL_HEADER_LEN) + (MBEDTLS2_SSL_IN_PAYLOAD_LEN))
#else
#define MBEDTLS2_SSL_IN_BUFFER_LEN                                      \
  ((MBEDTLS2_SSL_HEADER_LEN) + (MBEDTLS2_SSL_IN_PAYLOAD_LEN) +   \
...
#if !defined(MBEDTLS2_SSL_DTLS_CONNECTION_ID)
#define MBEDTLS2_SSL_OUT_BUFFER_LEN                                     \
  ((MBEDTLS2_SSL_HEADER_LEN) + (MBEDTLS2_SSL_OUT_PAYLOAD_LEN))
#else
#define MBEDTLS2_SSL_OUT_BUFFER_LEN                                     \
  ((MBEDTLS2_SSL_HEADER_LEN) + (MBEDTLS2_SSL_OUT_PAYLOAD_LEN) +  \
...
mbedtls2_ssl_get_output_buflen(const mbedtls2_ssl_context *ctx) {
#if defined(MBEDTLS2_SSL_DTLS_CONNECTION_ID)
  return mbedtls2_ssl_get_output_max_frag_len(ctx) +
         MBEDTLS2_SSL_HEADER_LEN + MBEDTLS2_SSL_PAYLOAD_OVERHEAD +
         MBEDTLS2_SSL_CID_OUT_LEN_MAX;
#else
  return mbedtls2_ssl_get_output_max_frag_len(ctx) +
         MBEDTLS2_SSL_HEADER_LEN + MBEDTLS2_SSL_PAYLOAD_OVERHEAD;
...
static inline size_t
mbedtls2_ssl_get_input_buflen(const mbedtls2_ssl_context *ctx) {
#if defined(MBEDTLS2_SSL_DTLS_CONNECTION_ID)
  return mbedtls2_ssl_get_input_max_frag_len(ctx) +
         MBEDTLS2_SSL_HEADER_LEN + MBEDTLS2_SSL_PAYLOAD_OVERHEAD +
         MBEDTLS2_SSL_CID_IN_LEN_MAX;
#else
  return mbedtls2_ssl_get_input_max_frag_len(ctx) +
...
#ifdef MBEDTLS2_ZLIB_SUPPORT
/* Compression buffer holds both IN and OUT buffers, so should be size of the
 * larger */
#define MBEDTLS2_SSL_COMPRESS_BUFFER_LEN                                \
  ((MBEDTLS2_SSL_IN_BUFFER_LEN > MBEDTLS2_SSL_OUT_BUFFER_LEN)    \
       ? MBEDTLS2_SSL_IN_BUFFER_LEN                                     \
 ...
 */
#define MBEDTLS2_TLS_EXT_SUPPORTED_POINT_FORMATS_PRESENT (1 << 0)
#define MBEDTLS2_TLS_EXT_ECJPAKE_KKPP_OK (1 << 1)
 ...
 *               otherwise.
 */
static inline int mbedtls2_ssl_chk_buf_ptr(const uint8_t *cur,
                                                  const uint8_t *end,
                                                  size_t need) {
 ...
 *
 */
#define MBEDTLS2_SSL_CHK_BUF_PTR(cur, end, need)                        \
  do {                                                                         \
    if (mbedtls2_ssl_chk_buf_ptr((cur), (end), (need)) != 0) {          \
 ...
 */
struct mbedtls2_ssl_sig_hash_set_t {
  /* At the moment, we only need to remember a single suitable
   * hash algorithm per signature algorithm. As long as that's
   * the case - and we don't need a general lookup function -
   * we can implement the sig-hash-set as a map from signatures
   * to hash algorithms. */
  mbedtls2_md_type_t rsa;
  mbedtls2_md_type_t ecdsa;
};
#endif /* MBEDTLS2_SSL_PROTO_TLS1_2 &&                                  \
          MBEDTLS2_KEY_EXCHANGE_WITH_CERT_ENABLED */

typedef int mbedtls2_ssl_tls_prf_cb(const unsigned char *secret,
 ...
 *
 * Since the current definitions of MBEDTLS2_MAX_{KEY|BLOCK|IV}_LENGTH
...
#define MBEDTLS2_SSL_MAX_BLOCK_LENGTH 16
#define MBEDTLS2_SSL_MAX_IV_LENGTH 16
#define MBEDTLS2_SSL_MAX_KEY_LENGTH 32

/**
 * \brief   The data structure holding the cryptographic material (key and IV)
 *          used for record protection in TLS 1.3.
 */
struct mbedtls2_ssl_key_set {
  /*! The key for client->server records. */
  unsigned char client_write_key[MBEDTLS2_SSL_MAX_KEY_LENGTH];
  /*! The key for server->client records. */
  unsigned char server_write_key[MBEDTLS2_SSL_MAX_KEY_LENGTH];
  /*! The IV  for client->server records. */
  unsigned char client_write_iv[MBEDTLS2_SSL_MAX_IV_LENGTH];
  /*! The IV  for server->client records. */
  unsigned char server_write_iv[MBEDTLS2_SSL_MAX_IV_LENGTH];
...
typedef struct mbedtls2_ssl_key_set mbedtls2_ssl_key_set;

/*
 * This structure contains the parameters only needed during handshake.
 */
struct mbedtls2_ssl_handshake_params {
  /*
  ...
  mbedtls2_x509_crt *ecrs_peer_cert; /*!< The peer's CRT chain. */
  ...
  mbedtls2_ssl_ciphersuite_t const *ciphersuite_info;

  void (*update_checksum)(mbedtls2_ssl_context *, const unsigned char *,
                          size_t);
  void (*calc_verify)(const mbedtls2_ssl_context *, unsigned char *,
                      size_t *);
  void (*calc_finished)(mbedtls2_ssl_context *, unsigned char *, int);
  mbedtls2_ssl_tls_prf_cb *tls_prf;

#if defined(MBEDTLS2_DHM_C)
  mbedtls2_dhm_context dhm_ctx; /*!<  DHM key exchange        */
#endif
 ...
 */
  ...
  mbedtls2_ecdh_context ecdh_ctx; /*!<  ECDH key exchange       */

#if defined(MBEDTLS2_USE_PSA_CRYPTO)
  psa_key_type_t ecdh_psa_type;
  uint16_t ecdh_bits;
  psa_key_id_t ecdh_psa_privkey;
  unsigned char ecdh_psa_peerkey[MBEDTLS2_PSA_MAX_EC_PUBKEY_LENGTH];
  size_t ecdh_psa_peerkey_len;
#endif /* MBEDTLS2_USE_PSA_CRYPTO */
#endif /* MBEDTLS2_ECDH_C || MBEDTLS2_ECDSA_C */

#if defined(MBEDTLS2_KEY_EXCHANGE_ECJPAKE_ENABLED)
  mbedtls2_ecjpake_context ecjpake_ctx; /*!< EC J-PAKE key exchange */
...
#if defined(MBEDTLS2_X509_CRT_PARSE_C)
  mbedtls2_ssl_key_cert *key_cert; /*!< chosen key/cert pair (server)  */
#if defined(MBEDTLS2_SSL_SERVER_NAME_INDICATION)
  mbedtls2_ssl_key_cert *sni_key_cert; /*!< key/cert list from SNI */
  mbedtls2_x509_crt *sni_ca_chain; /*!< trusted CAs from SNI callback  */
  mbedtls2_x509_crl *sni_ca_crl;   /*!< trusted CAs CRLs from SNI      */
#endif /* MBEDTLS2_SSL_SERVER_NAME_INDICATION */
#endif /* MBEDTLS2_X509_CRT_PARSE_C */

#if defined(MBEDTLS2_SSL_ECP_RESTARTABLE_ENABLED)
  mbedtls2_x509_crt_restart_ctx ecrs_ctx; /*!< restart context */
#endif

#if defined(MBEDTLS2_X509_CRT_PARSE_C) &&                               \
    !defined(MBEDTLS2_SSL_KEEP_PEER_CERTIFICATE)
  mbedtls2_pk_context peer_pubkey; /*!< The public key from the peer.  */
#endif /* MBEDTLS2_X509_CRT_PARSE_C &&                                  \
  ...
  struct {
    ...
    struct mbedtls2_ssl_hs_buffer {
      unsigned is_valid : 1;
      unsigned is_fragmented : 1;
      unsigned is_complete : 1;
      unsigned char *data;
      size_t data_len;
    } hs[MBEDTLS2_SSL_MAX_BUFFERED_HS];
  ...
  mbedtls2_ssl_flight_item *flight;  /*!<  Current outgoing flight  */
  mbedtls2_ssl_flight_item *cur_msg; /*!<  Current message in flight */
  unsigned char *cur_msg_p;         /*!<  Position in current message    */
  unsigned int in_flight_start_seq; /*!<  Minimum message sequence in the
                                          flight being received          */
  mbedtls2_ssl_transform *alt_transform_out; /*!<  Alternative transform
  ...
  uint8_t cid_in_use; /*!< This indicates whether the use of the CID extension
                       ...
                       *   #MBEDTLS2_SSL_CID_ENABLED and
                       *   #MBEDTLS2_SSL_CID_DISABLED. */
  unsigned char
      peer_cid[MBEDTLS2_SSL_CID_OUT_LEN_MAX]; /*! The peer's CID */
   ...
   */
    ...
    defined(MBEDTLS2_SSL_PROTO_TLS1) ||                                 \
    defined(MBEDTLS2_SSL_PROTO_TLS1_1)
  mbedtls2_md5_context fin_md5;
  mbedtls2_sha1_context fin_sha1;
#endif
#if defined(MBEDTLS2_SSL_PROTO_TLS1_2)
#if defined(MBEDTLS2_SHA256_C)
#if defined(MBEDTLS2_USE_PSA_CRYPTO)
...
#else
  mbedtls2_sha256_context fin_sha256;
#endif
#endif
#if defined(MBEDTLS2_SHA512_C)
#if defined(MBEDTLS2_USE_PSA_CRYPTO)
...
#else
  mbedtls2_sha512_context fin_sha512;
#endif
#endif
#endif /* MBEDTLS2_SSL_PROTO_TLS1_2 */

  unsigned char randbytes[64]; /*!<  random bytes            */
  unsigned char premaster[MBEDTLS2_PREMASTER_SIZE];
  /*!<  premaster secret        */

#if defined(MBEDTLS2_SSL_ASYNC_PRIVATE)
  /** Asynchronous operation context. This field is meant for use by the
   * asynchronous operation callbacks
   * (mbedtls2_ssl_config::f_async_sign_start,
   * mbedtls2_ssl_config::f_async_decrypt_start,
   * mbedtls2_ssl_config::f_async_resume,
   * mbedtls2_ssl_config::f_async_cancel). The library does not use it
   * internally. */
  void *user_async_ctx;
#endif /* MBEDTLS2_SSL_ASYNC_PRIVATE */
};

typedef struct mbedtls2_ssl_hs_buffer mbedtls2_ssl_hs_buffer;
 ...
 *   the type is MBEDTLS2_CIPHER_AES_256_CBC resp.
 * MBEDTLS2_CIPHER_AES_192_GCM then the transformation has type CBC resp.
 * AEAD.
...
struct mbedtls2_ssl_transform {
  ...
  mbedtls2_md_context_t md_ctx_enc; /*!<  MAC (encryption)        */
  mbedtls2_md_context_t md_ctx_dec; /*!<  MAC (decryption)        */
  ...
  mbedtls2_cipher_context_t cipher_ctx_enc; /*!<  encryption context */
  mbedtls2_cipher_context_t cipher_ctx_dec; /*!<  decryption context */
  int minor_ver;

#if defined(MBEDTLS2_SSL_DTLS_CONNECTION_ID)
  uint8_t in_cid_len;
  uint8_t out_cid_len;
  unsigned char in_cid[MBEDTLS2_SSL_CID_OUT_LEN_MAX];
  unsigned char out_cid[MBEDTLS2_SSL_CID_OUT_LEN_MAX];
#endif /* MBEDTLS2_SSL_DTLS_CONNECTION_ID */
 ...
 */
static inline int mbedtls2_ssl_transform_uses_aead(
    const mbedtls2_ssl_transform *transform) {
#if defined(MBEDTLS2_SSL_SOME_MODES_USE_MAC)
 ...
 *
 */
#if MBEDTLS2_SSL_CID_OUT_LEN_MAX > MBEDTLS2_SSL_CID_IN_LEN_MAX
#define MBEDTLS2_SSL_CID_LEN_MAX MBEDTLS2_SSL_CID_OUT_LEN_MAX
#else
#define MBEDTLS2_SSL_CID_LEN_MAX MBEDTLS2_SSL_CID_IN_LEN_MAX
#endif
...
typedef struct {
  ...
  uint8_t ver[2]; /* SSL/TLS version as present on the wire.
                   ...
                   * using mbedtls2_ssl_read_version() and
                   * mbedtls2_ssl_write_version().
  ...
  unsigned char cid[MBEDTLS2_SSL_CID_LEN_MAX]; /* The CID */
#endif /* MBEDTLS2_SSL_DTLS_CONNECTION_ID */
} mbedtls2_record;
 ...
 */
struct mbedtls2_ssl_key_cert {
  mbedtls2_x509_crt *cert;     /*!< cert                       */
  mbedtls2_pk_context *key;    /*!< private key                */
  mbedtls2_ssl_key_cert *next; /*!< next key/cert pair         */
};
#endif /* MBEDTLS2_X509_CRT_PARSE_C */
 ...
 */
struct mbedtls2_ssl_flight_item {
  unsigned char *p;   /*!< message, including handshake headers   */
  size_t len;         /*!< length of p                            */
  unsigned char type; /*!< type of the message: handshake or CCS  */
  mbedtls2_ssl_flight_item *next; /*!< next handshake message(s) */
};
#endif /* MBEDTLS2_SSL_PROTO_DTLS */
...
static inline void
mbedtls2_ssl_sig_hash_set_init(mbedtls2_ssl_sig_hash_set_t *set) {
  mbedtls2_ssl_sig_hash_set_const_hash(set, MBEDTLS2_MD_NONE);
}
...
int mbedtls2_ssl_handshake_client_step(mbedtls2_ssl_context *ssl);
int mbedtls2_ssl_handshake_server_step(mbedtls2_ssl_context *ssl);
 ...
 *
 *              a Updating
 *                [Currently implemented by mbedtls2_ssl_read_record]
 *
 ...
 *              application data reading function mbedtls2_ssl_read.
 *
 * \note        The above tries to give a conceptual picture of the
 *              record layer, but the current implementation deviates
 *              from it in some places. For example, our implementation of
 *              the update functionality through mbedtls2_ssl_read_record
 ...
 * 1. handshake PSK set by \c mbedtls2_ssl_set_hs_psk() in the PSK
 * callback
 * 2. static PSK configured by \c mbedtls2_ssl_conf_psk()
 * Return a code and update the pair (PSK, PSK length) passed to this function
 */
static inline int
mbedtls2_ssl_get_psk(const mbedtls2_ssl_context *ssl,
 ...
 * 1. handshake PSK set by \c mbedtls2_ssl_set_hs_psk_opaque() in the PSK
 *    callback
 * 2. static PSK configured by \c mbedtls2_ssl_conf_psk_opaque()
 * Return an opaque PSK
 */
static inline psa_key_id_t
mbedtls2_ssl_get_opaque_psk(const mbedtls2_ssl_context *ssl) {
  ...
  return (MBEDTLS2_SVC_KEY_ID_INIT);
}
#endif /* MBEDTLS2_USE_PSA_CRYPTO */
...
static inline mbedtls2_ssl_srtp_profile
mbedtls2_ssl_check_srtp_profile_value(
  ...
  return (MBEDTLS2_TLS_SRTP_UNSET);
}
#endif

#if defined(MBEDTLS2_X509_CRT_PARSE_C)
static inline mbedtls2_pk_context *
mbedtls2_ssl_own_key(mbedtls2_ssl_context *ssl) {
  mbedtls2_ssl_key_cert *key_cert;
...
static inline mbedtls2_x509_crt *
mbedtls2_ssl_own_cert(mbedtls2_ssl_context *ssl) {
  mbedtls2_ssl_key_cert *key_cert;
...
static inline size_t
mbedtls2_ssl_in_hdr_len(const mbedtls2_ssl_context *ssl) {
#if !defined(MBEDTLS2_SSL_PROTO_DTLS)
  ((void)ssl);
#endif
...
static inline size_t
mbedtls2_ssl_out_hdr_len(const mbedtls2_ssl_context *ssl) {
  return ((size_t)(ssl->out_iv - ssl->out_hdr));
}

static inline size_t
mbedtls2_ssl_hs_hdr_len(const mbedtls2_ssl_context *ssl) {
#if defined(MBEDTLS2_SSL_PROTO_DTLS)
  if (ssl->conf->transport == MBEDTLS2_SSL_TRANSPORT_DATAGRAM)
    return (12);
#else
...
int mbedtls2_ssl_get_key_exchange_md_ssl_tls(
    ...
    defined(MBEDTLS2_SSL_PROTO_TLS1_1) ||                               \
    defined(MBEDTLS2_SSL_PROTO_TLS1_2)
/* The hash buffer must have at least MBEDTLS2_MD_MAX_SIZE bytes of
 * length. */
...
static inline size_t
mbedtls2_ssl_ep_len(const mbedtls2_ssl_context *ssl) {
#if defined(MBEDTLS2_SSL_PROTO_DTLS)
  if (ssl->conf->transport == MBEDTLS2_SSL_TRANSPORT_DATAGRAM)
    return (2);
#else
