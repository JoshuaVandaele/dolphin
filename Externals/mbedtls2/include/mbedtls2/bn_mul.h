 ...
 */
#ifndef MBEDTLS2_BN_MUL_H
#define MBEDTLS2_BN_MUL_H
 ...
 * build lists of mbedtls2_mpi_uint's from lists of unsigned char's
 * grouped by 8, 4 or 2
 */
#if defined(MBEDTLS2_HAVE_INT32)

#define MBEDTLS2_BYTES_TO_T_UINT_4(a, b, c, d)                          \
  ((mbedtls2_mpi_uint)(a) << 0) |                                       \
      ((mbedtls2_mpi_uint)(b) << 8) |                                   \
      ((mbedtls2_mpi_uint)(c) << 16) |                                  \
      ((mbedtls2_mpi_uint)(d) << 24)

#define MBEDTLS2_BYTES_TO_T_UINT_2(a, b)                                \
  MBEDTLS2_BYTES_TO_T_UINT_4(a, b, 0, 0)

#define MBEDTLS2_BYTES_TO_T_UINT_8(a, b, c, d, e, f, g, h)              \
  MBEDTLS2_BYTES_TO_T_UINT_4(a, b, c, d),                               \
      MBEDTLS2_BYTES_TO_T_UINT_4(e, f, g, h)
...
#define MBEDTLS2_BYTES_TO_T_UINT_8(a, b, c, d, e, f, g, h)              \
  ((mbedtls2_mpi_uint)(a) << 0) |                                       \
      ...
      ((mbedtls2_mpi_uint)(c) << 16) |                                  \
      ((mbedtls2_mpi_uint)(d) << 24) |                                  \
      ((mbedtls2_mpi_uint)(e) << 32) |                                  \
      ((mbedtls2_mpi_uint)(f) << 40) |                                  \
      ((mbedtls2_mpi_uint)(g) << 48) |                                  \
      ((mbedtls2_mpi_uint)(h) << 56)

#define MBEDTLS2_BYTES_TO_T_UINT_4(a, b, c, d)                          \
  MBEDTLS2_BYTES_TO_T_UINT_8(a, b, c, d, 0, 0, 0, 0)

#define MBEDTLS2_BYTES_TO_T_UINT_2(a, b)                                \
  MBEDTLS2_BYTES_TO_T_UINT_8(a, b, 0, 0, 0, 0, 0, 0)

#endif /* bits in mbedtls2_mpi_uint */
...
#define MULADDC_INIT                                                           \
  {                                                                            \
    mbedtls2_t_udbl r;                                                  \
    mbedtls2_mpi_uint r0, r1;

#define MULADDC_CORE                                                           \
  r = *(s++) * (mbedtls2_t_udbl)b;                                      \
  r0 = (mbedtls2_mpi_uint)r;                                            \
  r1 = (mbedtls2_mpi_uint)(r >> biL);                                   \
  r0 += c;                                                                     \
  r1 += (r0 < c);                                                              \
  r0 += *d;                                                                    \
  r1 += (r0 < *d);                                                             \
...
#define MULADDC_INIT                                                           \
  {                                                                            \
    mbedtls2_mpi_uint s0, s1, b0, b1;                                   \
    mbedtls2_mpi_uint r0, r1, rx, ry;                                   \
    b0 = (b << biH) >> biH;                                                    \
    b1 = (b >> biH);
