 ...
 */
#ifndef MBEDTLS2_ECJPAKE_H
#define MBEDTLS2_ECJPAKE_H
 ...
 */
typedef enum {
  MBEDTLS2_ECJPAKE_CLIENT = 0, /**< Client                         */
  MBEDTLS2_ECJPAKE_SERVER,     /**< Server                         */
 ...
 */
typedef struct mbedtls2_ecjpake_context {
 ...
 *                  #MBEDTLS2_ECJPAKE_CLIENT or
 * #MBEDTLS2_ECJPAKE_SERVER.
 * \param hash      The identifier of the hash function to use,
 *                  for example #MBEDTLS2_MD_SHA256.
 * \param curve     The identifier of the elliptic curve to use,
 *                  for example #MBEDTLS2_ECP_DP_SECP256R1.
 ...
 * \return          #MBEDTLS2_ERR_ECP_BAD_INPUT_DATA otherwise.
 */
