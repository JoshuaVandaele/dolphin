 ...
 */
#ifndef MBEDTLS2_HAVEGE_H
#define MBEDTLS2_HAVEGE_H
...
#define MBEDTLS2_HAVEGE_COLLECT_SIZE 1024
 ...
 */
typedef struct mbedtls2_havege_state {
  uint32_t PT1, PT2, offset[2];
  uint32_t pool[MBEDTLS2_HAVEGE_COLLECT_SIZE];
  uint32_t WALK[8192];
 ...
 * \return         0
 */
int mbedtls2_havege_random(void *p_rng, unsigned char *output,
                                  size_t len);
