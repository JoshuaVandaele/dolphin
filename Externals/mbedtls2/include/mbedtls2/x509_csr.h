 ...
 */
#ifndef MBEDTLS2_X509_CSR_H
#define MBEDTLS2_X509_CSR_H
 ...
 */
typedef struct mbedtls2_x509_csr {
  mbedtls2_x509_buf raw; /**< The raw CSR data (DER). */
  mbedtls2_x509_buf
      cri; /**< The raw CertificateRequestInfo body (DER). */

  int version; /**< CSR version (1=v1). */

  mbedtls2_x509_buf subject_raw; /**< The raw subject data (DER). */
  mbedtls2_x509_name
      subject; /**< The parsed subject data (named information object). */

  mbedtls2_pk_context pk; /**< Container for the public key context. */

  mbedtls2_x509_buf sig_oid;
 ...
 *
 * \note           See notes for \c mbedtls2_x509_csr_parse_der()
 *
 * \param csr      CSR context to fill
 * \param buf      buffer holding the CRL data
 * \param buflen   size of the buffer
 ...
 *
 * \note           See notes for \c mbedtls2_x509_csr_parse()
 *
 * \param csr      CSR context to fill
 ...
 *                  #MBEDTLS2_X509_KU_DECIPHER_ONLY) cannot be set using
 * this function.
 */
