...
struct ButtonNameOverride
{
  SDL_GamepadType type;
  SDL_GamepadButton button;
  const char* name;
};
struct AxisNameOverride
{
  SDL_GamepadType type;
...
constexpr std::array<ButtonNameOverride, 73> s_button_name_overrides = {{
    // Steam Controller
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_MISC1, "Quick Access Menu"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_MISC2, "Right Trackpad Click"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_MISC3, "Left Stick Touch"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_MISC4, "Right Stick Touch"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_MISC5, "Left Grip Sense"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_MISC6, "Right Grip Sense"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_GUIDE, "Steam"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_BACK, "View"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_START, "Menu"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_LEFT_STICK, "Thumbstick L3"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_RIGHT_STICK, "Thumbstick R3"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_LEFT_SHOULDER, "L1"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER, "R1"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_TOUCHPAD, "Left Trackpad Click"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_RIGHT_PADDLE1, "R4"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_LEFT_PADDLE1, "L4"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_RIGHT_PADDLE2, "R5"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_BUTTON_LEFT_PADDLE2, "L5"},
    // XBOX One Controller
    {SDL_GAMEPAD_TYPE_XBOXONE, SDL_GAMEPAD_BUTTON_GUIDE, "XBOX"},
    {SDL_GAMEPAD_TYPE_XBOXONE, SDL_GAMEPAD_BUTTON_BACK, "View"},
    {SDL_GAMEPAD_TYPE_XBOXONE, SDL_GAMEPAD_BUTTON_START, "Menu"},
    // Nintendo Switch Pro Controller
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_PRO, SDL_GAMEPAD_BUTTON_MISC1, "Capture"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_PRO, SDL_GAMEPAD_BUTTON_GUIDE, "HOME"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_PRO, SDL_GAMEPAD_BUTTON_BACK, "-"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_PRO, SDL_GAMEPAD_BUTTON_START, "+"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_PRO, SDL_GAMEPAD_BUTTON_LEFT_SHOULDER, "L"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_PRO, SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER, "R"},
    // Joy-Con (Pair)
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR, SDL_GAMEPAD_BUTTON_MISC1, "Capture"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR, SDL_GAMEPAD_BUTTON_GUIDE, "HOME"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR, SDL_GAMEPAD_BUTTON_BACK, "-"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR, SDL_GAMEPAD_BUTTON_START, "+"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR, SDL_GAMEPAD_BUTTON_LEFT_SHOULDER, "L"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR, SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER, "R"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR, SDL_GAMEPAD_BUTTON_RIGHT_PADDLE1, "Right SR"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR, SDL_GAMEPAD_BUTTON_LEFT_PADDLE1, "Left SL"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR, SDL_GAMEPAD_BUTTON_RIGHT_PADDLE2, "Right SL"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR, SDL_GAMEPAD_BUTTON_LEFT_PADDLE2, "Left SR"},
    // Joy-Con (L)
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_LEFT, SDL_GAMEPAD_BUTTON_LEFT_SHOULDER, "SL"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_LEFT, SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER, "SR"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_LEFT, SDL_GAMEPAD_BUTTON_LEFT_PADDLE1, "L"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_LEFT, SDL_GAMEPAD_BUTTON_LEFT_PADDLE2, "ZL"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_LEFT, SDL_GAMEPAD_BUTTON_START, "-"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_LEFT, SDL_GAMEPAD_BUTTON_GUIDE, "Capture"},
    // Joy-Con (R)
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_RIGHT, SDL_GAMEPAD_BUTTON_LEFT_SHOULDER, "SL"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_RIGHT, SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER, "SR"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_RIGHT, SDL_GAMEPAD_BUTTON_LEFT_PADDLE1, "R"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_RIGHT, SDL_GAMEPAD_BUTTON_LEFT_PADDLE2, "ZR"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_RIGHT, SDL_GAMEPAD_BUTTON_START, "+"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_RIGHT, SDL_GAMEPAD_BUTTON_GUIDE, "HOME"},
    // PS3 Controller
    {SDL_GAMEPAD_TYPE_PS3, SDL_GAMEPAD_BUTTON_GUIDE, "PS"},
    {SDL_GAMEPAD_TYPE_PS3, SDL_GAMEPAD_BUTTON_BACK, "Select"},
    {SDL_GAMEPAD_TYPE_PS3, SDL_GAMEPAD_BUTTON_START, "Start"},
    {SDL_GAMEPAD_TYPE_PS3, SDL_GAMEPAD_BUTTON_LEFT_SHOULDER, "L1"},
    {SDL_GAMEPAD_TYPE_PS3, SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER, "R1"},
    {SDL_GAMEPAD_TYPE_PS3, SDL_GAMEPAD_BUTTON_LEFT_STICK, "L3"},
    {SDL_GAMEPAD_TYPE_PS3, SDL_GAMEPAD_BUTTON_RIGHT_STICK, "R3"},
    // PS4 Controller
    {SDL_GAMEPAD_TYPE_PS4, SDL_GAMEPAD_BUTTON_GUIDE, "PS"},
    {SDL_GAMEPAD_TYPE_PS4, SDL_GAMEPAD_BUTTON_BACK, "Share"},
    {SDL_GAMEPAD_TYPE_PS4, SDL_GAMEPAD_BUTTON_START, "Options"},
    {SDL_GAMEPAD_TYPE_PS4, SDL_GAMEPAD_BUTTON_LEFT_SHOULDER, "L1"},
    {SDL_GAMEPAD_TYPE_PS4, SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER, "R1"},
    {SDL_GAMEPAD_TYPE_PS4, SDL_GAMEPAD_BUTTON_LEFT_STICK, "L3"},
    {SDL_GAMEPAD_TYPE_PS4, SDL_GAMEPAD_BUTTON_RIGHT_STICK, "R3"},
    // PS5 Controller
    {SDL_GAMEPAD_TYPE_PS5, SDL_GAMEPAD_BUTTON_GUIDE, "PS"},
    {SDL_GAMEPAD_TYPE_PS5, SDL_GAMEPAD_BUTTON_BACK, "Create"},
    {SDL_GAMEPAD_TYPE_PS5, SDL_GAMEPAD_BUTTON_START, "Options"},
    {SDL_GAMEPAD_TYPE_PS5, SDL_GAMEPAD_BUTTON_LEFT_SHOULDER, "L1"},
    {SDL_GAMEPAD_TYPE_PS5, SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER, "R1"},
    {SDL_GAMEPAD_TYPE_PS5, SDL_GAMEPAD_BUTTON_LEFT_STICK, "L3"},
    {SDL_GAMEPAD_TYPE_PS5, SDL_GAMEPAD_BUTTON_RIGHT_STICK, "R3"},
    {SDL_GAMEPAD_TYPE_PS5, SDL_GAMEPAD_BUTTON_MISC1, "Mute"},
}};
...
constexpr std::array<AxisNameOverride, 12> s_axis_name_overrides = {{
    // Steam Controller
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_AXIS_LEFT_TRIGGER, "L2"},
    {SDL_GAMEPAD_TYPE_STEAM, SDL_GAMEPAD_AXIS_RIGHT_TRIGGER, "R2"},
    // Nintendo Switch Pro Controller
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_PRO, SDL_GAMEPAD_AXIS_LEFT_TRIGGER, "ZL"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_PRO, SDL_GAMEPAD_AXIS_RIGHT_TRIGGER, "ZR"},
    // Joy-Con (Pair)
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR, SDL_GAMEPAD_AXIS_LEFT_TRIGGER, "ZL"},
    {SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR, SDL_GAMEPAD_AXIS_RIGHT_TRIGGER, "ZR"},
    // PS3 Controller
    {SDL_GAMEPAD_TYPE_PS3, SDL_GAMEPAD_AXIS_LEFT_TRIGGER, "L2"},
    {SDL_GAMEPAD_TYPE_PS3, SDL_GAMEPAD_AXIS_RIGHT_TRIGGER, "R2"},
    // PS4 Controller
    {SDL_GAMEPAD_TYPE_PS4, SDL_GAMEPAD_AXIS_LEFT_TRIGGER, "L2"},
    {SDL_GAMEPAD_TYPE_PS4, SDL_GAMEPAD_AXIS_RIGHT_TRIGGER, "R2"},
    // PS5 Controller
    {SDL_GAMEPAD_TYPE_PS5, SDL_GAMEPAD_AXIS_LEFT_TRIGGER, "L2"},
    {SDL_GAMEPAD_TYPE_PS5, SDL_GAMEPAD_AXIS_RIGHT_TRIGGER, "R2"},
}};
